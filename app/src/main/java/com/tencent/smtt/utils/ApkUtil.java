...
public class ApkUtil {
   public static boolean getApkVersion(Context var0, File var1, long var2, int var4) {
      if (var1 != null && var1.exists()) {
         if (var2 > 0L && var2 != var1.length()) {
            return false;
         } else {
            try {
               int var5 = getApkVersion(var0, var1);
               if (var4 != var5) {
                  return false;
               } else {
                  String var6 = AppUtil.getSignatureFromApk(var0, true, var1);
   ...
   public static String a(File var0) {
      ...
      try {
         ...
         int var23;
         while((var23 = var2.read(var22)) != -1) {
            var6.update(var22, 0, var23);
         }
         ...
         for(int var10 = 0; var10 < 16; ++var10) {
            ...
            var4[var5++] = var1[var11 >>> 4 & 15];
            var4[var5++] = var1[var11 & 15];
         }
   ...
   public static int a(Context var0, File var1, boolean var2) {
      ...
      try {
         if (var1 != null && var1.exists()) {
            ...
            if (var2 || var4) {
               var3 = getApkVersionByReadFile(var1);
               if (var3 > 0) {
                  return var3;
               }
   ...
   public static int getApkVersionByReadFile(File var0) {
      TbsLog.i("ApkUtil", "getApkVersionByReadFile" + var0 + "exists:" + var0.exists() + ";canread:" + var0.canRead());
      Class var1 = ApkUtil.class;
