...
public class d {
         ...
         public void a() {
            var2.post(new Runnable() {
               public void run() {
                  ...
                  d.this.a(var1, var2, var3, com.tencent.smtt.utils.d.c);
               }
            });
         }
   ...
   @SuppressLint({"NewApi"})
   public static void a(final String var0, final d.a var1) {
      (new Thread() {
         public void run() {
   ...
   @SuppressLint({"NewApi"})
   public void a(String var1, WebView var2, Context var3, Looper var4) {
      ...
      if (!var8.exists()) {
         ...
         try {
            String var9 = "";
            var9 = AppUtil.getSignatureFromApk(var3, true, new File(var6));
