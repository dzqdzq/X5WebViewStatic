...
public class TbsDownloader {
   ...
   public static String getBackupFileName(boolean var0) {
      if (var0) {
         return com.tencent.smtt.utils.AppUtil.is64Bit() ? "x5.tbs.decouple.64" : "x5.tbs.decouple";
      } else {
         return com.tencent.smtt.utils.AppUtil.is64Bit() ? "x5.tbs.org.64" : "x5.tbs.org";
      }
   }
   ...
   private static boolean a(Context var0, boolean var1, boolean var2) {
      ...
      c var4 = com.tencent.smtt.sdk.c.a();
      var4.a(var0, 1000, new c.a() {
         public void a(String var1) {
            TbsLog.e("TBSEmergency", "Execute command [1000](" + var1 + "), force tbs downloader request");
      ...
      if (!var1) {
         ...
         String var11 = com.tencent.smtt.utils.AppUtil.c(c);
         int var12 = com.tencent.smtt.utils.AppUtil.d(c);
         String var13 = com.tencent.smtt.utils.AppUtil.a(c, "com.tencent.mm.BuildInfo.CLIENT_VERSION");
         ...
         if (var14 - var16 > var22 * 1000L) {
            var5 = true;
         } else if (var25 > o.a().j(c) && var25 > var26) {
            var5 = true;
   ...
   public static boolean needDownload(Context var0, boolean var1, boolean var2, boolean var3, TbsDownloader.TbsDownloaderCallback var4) {
      ...
      var5.commit();
      o.a().b(var0, SDKEngine.a == 0);
      int var6 = o.a().b(var0);
      TbsLog.i("TbsDownload", "[TbsDownloader.needDownload],renameRet=" + var6);
      if (var6 != 0) {
         TbsLogReport.TbsLogInfo var7 = TbsLogReport.getInstance(var0).tbsLogInfo();
         var7.a = 129;
         var7.setFailDetail("code=2" + var6);
         TbsLogReport.getInstance(var0).eventReport(TbsLogReport.EventType.TYPE_SDK_REPORT_INFO, var7);
      }

      if (var6 < 0) {
         TbsLog.i("TbsDownload", "[TbsDownloader.needDownload],needReNameFile=" + var6);
         return false;
      } else {
         ...
         if (o.b) {
            ...
            TbsLog.i("TbsDownload", "[TbsDownloader.needDownload]#1,return " + var13);
            var5.a.put("tbs_needdownload_return", var13 ? 170 : 171);
            var5.commit();
            return var13;
         } else {
            TbsLog.app_extra("TbsDownload", var0);
            c = var0.getApplicationContext();
            TbsDownloadConfig var8 = TbsDownloadConfig.getInstance(c);
            var8.setDownloadInterruptCode(-100);
            if (!a(c, var1)) {
               TbsLog.i("TbsDownload", "[TbsDownloader.needDownload]#2,return " + var13);
               var5.a.put("tbs_needdownload_code", 141);
               var5.commit();
               var5.a.put("tbs_needdownload_return", var13 ? 170 : 172);
               var5.commit();
               if (var4 != null) {
                  var4.onNeedDownloadFinish(false, 0);
               }
               ...
               if (i) {
                  ...
                  var8.setDownloadInterruptCode(-105);
                  TbsLog.i("TbsDownload", "[TbsDownloader.needDownload]#3,return " + var13);
                  ...
                  boolean var9 = false;
                  boolean var10 = a(c, var2, false);
                  TbsLog.i("TbsDownload", "[TbsDownloader.needDownload],needSendRequest=" + var10);
                  if (var10) {
                     a(var2, var4, var3);
                     var8.setDownloadInterruptCode(-114);
                  } else {
                  ...
                  if (QbSdk.c || !TbsShareManager.isThirdPartyApp(var0)) {
                     var11 = var8.mPreferences.contains("tbs_needdownload");
                     TbsLog.i("TbsDownload", "[TbsDownloader.needDownload] hasNeedDownloadKey=" + var11);
                     if (!var11 && !TbsShareManager.isThirdPartyApp(var0)) {
                        var13 = true;
                     } else {
                        var13 = var8.mPreferences.getBoolean("tbs_needdownload", false);
                     }
                  }

                  TbsLog.i("TbsDownload", "[TbsDownloader.needDownload]#4,needDownload=" + var13 + ",hasNeedDownloadKey=" + var11);
                  if (var13) {
                     if (!h()) {
                        var13 = false;
                        TbsLog.i("TbsDownload", "[TbsDownloader.needDownload]#5,set needDownload = false");
                     } else {
                        var8.setDownloadInterruptCode(-118);
                        TbsLog.i("TbsDownload", "[TbsDownloader.needDownload]#6");
                     }
                  } else {
                     int var12 = o.a().n(c);
                     TbsLog.i("TbsDownload", "[TbsDownloader.needDownload]#7,tbsLocalVersion=" + var12 + ",needSendRequest=" + var10);
                     if (!var10 && var12 > 0) {
                        var8.setDownloadInterruptCode(-119);
                     } else {
                        ...
                        var8.setDownloadInterruptCode(-121);
                     }
                  }
                  ...
                  TbsLog.i("TbsDownload", "[TbsDownloader.needDownload] needDownload=" + var13);
                  var5.a.put("tbs_needdownload_return", var13 ? 170 : 174);
                  var5.commit();
                  return var13;
               }
            }
   ...
   public static synchronized void startDownload(Context var0, boolean var1) {
      ...
      if (o.b) {
         ...
         o.a().b(var0, SDKEngine.a == 0);
         int var3 = o.a().b(var0);
         TbsLog.i("TbsDownload", "[TbsDownloader.needDownload],renameRet11=" + var3);
         if (var3 != 0) {
            TbsLogReport.TbsLogInfo var4 = TbsLogReport.getInstance(var0).tbsLogInfo();
            var4.a = 129;
            var4.setFailDetail("code=2" + var3);
            TbsLogReport.getInstance(var0).eventReport(TbsLogReport.EventType.TYPE_SDK_REPORT_INFO, var4);
         }

         if (var3 < 0) {
            TbsLog.i("TbsDownload", "[TbsDownloader.needDownload],needReNameFile=" + var3);
         } else {
            a = true;
            c = var0.getApplicationContext();
            ...
            if (VERSION.SDK_INT < 8) {
               ...
               if (i) {
                  ...
                  Message var5 = Message.obtain(d, 101, QbSdk.m);
                  var5.arg1 = var1 ? 1 : 0;
                  var5.sendToTarget();
               }
            }
   ...
   public static boolean needDownloadDecoupleCore() {
      if (TbsShareManager.isThirdPartyApp(c)) {
         ...
         if (var2 - var0 < var4 * 1000L) {
            ...
            return var6 > 0 && var6 != o.a().i(c) && TbsDownloadConfig.getInstance(c).mPreferences.getInt("tbs_download_version", 0) != var6;
         }
      }
   }
         ...
         if (a(c)) {
            ...
            if (var2 - var0 < var4 * 1000L) {
               ...
               if (var6 > 0 && var6 != o.a().i(c)) {
                  ...
                  TbsLog.i("TbsDownload", "startDecoupleCoreIfNeeded no need, deCoupleCoreVersion is " + var6 + " getTbsCoreShareDecoupleCoreVersion is " + o.a().i(c));
               }
            ...
            public void handleMessage(Message var1) {
               ...
               case 108:
                  ...
                  if (!TbsShareManager.isThirdPartyApp(TbsDownloader.c)) {
                     ...
                     var5 = FileUtil.b(TbsDownloader.c, false, var7);
                     if (var5 != null) {
                        var6 = FileUtil.a(TbsDownloader.c, var5);
                        if (var6 == null) {
                  ...
                  if (var4) {
                     if (var2 && o.a().b(TbsDownloader.c, TbsDownloadConfig.getInstance(TbsDownloader.c).mPreferences.getInt("tbs_download_version", 0))) {
                        ...
                        TbsDownloader.g.b(var2, 108 == var1.what);
                     } else {
                        QbSdk.m.onDownloadFinish(110);
                     }
                  } else {
                  ...
                  FileUtil.freeFileLock(var6, var5);
                  break;
               case 102:
                  TbsLog.i("TbsDownload", "[TbsDownloader.handleMessage] MSG_REPORT_DOWNLOAD_STAT");
                  int var8 = TbsShareManager.isThirdPartyApp(TbsDownloader.c) ? TbsShareManager.a(TbsDownloader.c, false) : o.a().n(TbsDownloader.c);
               ...
               case 103:
                  ...
                  if (var1.arg1 == 0) {
                     o.a().a((Context)var1.obj, true);
                  } else {
                     o.a().a((Context)var1.obj, false);
                  }
                  break;
               case 104:
               ...
               case 109:
                  if (TbsDownloader.g != null) {
                     TbsDownloader.g.resumeDownload();
                  }
               }
      ...
      for(var3 = 0; var3 < var2; ++var3) {
         ...
         if (var5 > 0) {
            ...
            if (var6 != null && !o.a().g(var6)) {
               ...
               if (!var7) {
                  TbsLog.i("TbsDownload", "addCoreVersionToJsonData,pkg=" + var4 + ";version=" + var5);
                  var0.put(var5);
               }
            }
         }
      ...
      for(var3 = 0; var3 < var2; ++var3) {
         ...
         if (var5 > 0) {
            ...
            if (var6 != null && !o.a().g(var6)) {
               ...
               if (!var7) {
                  TbsLog.i("TbsDownload", "addCoreVersionToJsonDataByDecouple,pkg=" + var4 + ";version=" + var5);
                  var0.put(var5);
               }
            }
         }
   ...
   private static void b(JSONArray var0) {
      if (TbsShareManager.getHostCorePathAppDefined() != null) {
         int var1 = o.a().a(TbsShareManager.getHostCorePathAppDefined());
         boolean var2 = false;
      ...
      if (!TbsPVConfig.getInstance(c).isDisableHostBackupCore()) {
         ...
         for(int var3 = 0; var3 < var2; ++var3) {
            ...
            if (var5 > 0) {
               ...
               if (var6 != null && !o.a().g(var6)) {
                  TbsLog.e("TbsDownload", "addBackupVersionToJsonData,host check failed,packageName = " + var4);
                  continue;
               }
               ...
               if (!var7) {
                  TbsLog.i("TbsDownload", "addBackupVersionToJsonData,pkg=" + var4 + ";version=" + var5);
                  var0.put(var5);
               }
            }
            ...
            if (var5 > 0) {
               ...
               if (var6 != null && !o.a().g(var6)) {
                  ...
                  if (!var7) {
                     TbsLog.i("TbsDownload", "addBackupVersionToJsonDataByDecouple,pkg=" + var4 + ";version=" + var5);
                     var0.put(var5);
                  }
               }
            }
   ...
   private static JSONObject a(boolean var0, boolean var1, boolean var2) {
      ...
      TbsDownloadConfig var3 = TbsDownloadConfig.getInstance(c);
      String var4 = b(c);
      String var5 = com.tencent.smtt.utils.AppUtil.getImsi(c);
      String var6 = com.tencent.smtt.utils.AppUtil.getImei(c);
      String var7 = com.tencent.smtt.utils.AppUtil.getAndroidID(c);
      String var8 = "";
      String var9 = "";
      String var10 = "";
      ...
      try {
         int var12 = m.a(c).c("tpatch_num");
         if (var12 < 5) {
            if (TbsShareManager.isThirdPartyApp(c)) {
               var21.put("REQUEST_TPATCH", 2);
            } else {
         ...
         if (com.tencent.smtt.utils.AppUtil.is64Bit()) {
         ...
         var21.put("GUID", com.tencent.smtt.utils.AppUtil.getGuid(c));
         if (!TbsShareManager.isThirdPartyApp(c)) {
            if (var22 != 0) {
   ...
   private static boolean b(final boolean var0, boolean var1, boolean var2, boolean var3) {
      ...
      if (QbSdk.n != null && QbSdk.n.containsKey("SET_SENDREQUEST_AND_UPLOAD") && QbSdk.n.get("SET_SENDREQUEST_AND_UPLOAD").equals("false")) {
         ...
         boolean var23 = o.a().isTbsLocalInstalled(c);
         if (var23) {
            ...
            File var7 = new File(FileUtil.a(c, 1), getOverSea(c) ? "x5.oversea.tbs.org" : getBackupFileName(false));
            File var8 = new File(FileUtil.a(c, 2), getOverSea(c) ? "x5.oversea.tbs.org" : getBackupFileName(false));
            File var9 = new File(FileUtil.a(c, 3), getOverSea(c) ? "x5.oversea.tbs.org" : getBackupFileName(false));
            File var10 = new File(FileUtil.a(c, 4), getOverSea(c) ? "x5.oversea.tbs.org" : getBackupFileName(false));
            if (!var10.exists()) {
               if (var9.exists()) {
                  var9.renameTo(var10);
               } else if (var8.exists()) {
            ...
            if (e == null) {
               e = com.tencent.smtt.utils.AppUtil.getCpuArch();
            ...
            var6.mSyncMap.put("app_versionname", com.tencent.smtt.utils.AppUtil.c(c));
            var6.mSyncMap.put("app_versioncode", com.tencent.smtt.utils.AppUtil.d(c));
            var6.commit();
            ...
            if (var11 || var26 != -1) {
               ...
               var6.mSyncMap.put("app_versionname", com.tencent.smtt.utils.AppUtil.c(c));
               var6.mSyncMap.put("app_versioncode", com.tencent.smtt.utils.AppUtil.d(c));
               var6.mSyncMap.put("app_metadata", com.tencent.smtt.utils.AppUtil.a(c, "com.tencent.mm.BuildInfo.CLIENT_VERSION"));
               var6.commit();
               if (var11) {
                  if (var0) {
            ...
            if (var26 == -1 && !var2) {
               ...
               try {
                  com.tencent.smtt.utils.m var27 = com.tencent.smtt.utils.m.a(c);
      ...
      if (TextUtils.isEmpty(var0)) {
         ...
         if (var7 != 0) {
            ...
            if (var2 && QbSdk.i && TbsShareManager.isThirdPartyApp(c)) {
               ...
               try {
                  var49 = var6.optInt("BUGLY", 0);
                  TbsExtensionFunctionManager.getInstance().setFunctionEnable(c, "bugly_switch.txt", var49 == 1);
            ...
            if (var2) {
               try {
                  var49 = var6.optInt("TEMPLATESWITCH", 0);
                  boolean var25 = (var49 & 1) != 0;
                  ...
                  TbsLog.i("qbsdk", "throwable:" + var45.toString());
               }
            }
            ...
            try {
               var50 = var6.getString("PKGMD5");
               var51 = var6.getInt("RESETX5");
               var53 = var6.getInt("UPLOADLOG");
               if (var6.has("RESETTOKEN")) {
                  var28 = var6.getInt("RESETTOKEN") != 0;
               }

               if (var6.has("SETTOKEN")) {
                  var30 = var6.getString("SETTOKEN");
               }

               if (var6.has("ENABLE_LOAD_RENAME_FILE_LOCK_WAIT")) {
                  var29 = var6.getInt("ENABLE_LOAD_RENAME_FILE_LOCK_WAIT") != 0;
               }
            } catch (Exception var44) {
            }

            try {
               var52 = var6.getInt("RESETDECOUPLECORE");
            ...
            try {
               var31 = var6.getInt("RESETTODECOUPLECORE");
            ...
            synchronized(f) {
               ...
               if (!TextUtils.isEmpty(var30) && var30.length() == 96) {
                  String var33 = var30 + "&" + com.tencent.smtt.utils.g.c();
                  var5.mSyncMap.put("tbs_deskey_token", var33);
               }
            }
            ...
            if (var51 == 1) {
               ...
               if (getRetryIntervalInSeconds() >= 0L) {
                  var32 = getRetryIntervalInSeconds();
               }

               var5.mSyncMap.put("retry_interval", var32);
               int var34 = 0;
               int var35 = 0;

               try {
                  if (var2) {
                     var34 = var6.getInt("DECOUPLECOREVERSION");
                  } else {
                     var34 = TbsDownloadConfig.getInstance(c).mPreferences.getInt("tbs_decouplecoreversion", 0);
                  }
               } catch (Exception var41) {
               }

               try {
                  var35 = TbsDownloadConfig.getInstance(c).mPreferences.getInt("tbs_downloaddecouplecore", 0);
               } catch (Exception var40) {
               }

               if (var2 && !TbsShareManager.isThirdPartyApp(c) && var34 == 0) {
                  var34 = o.a().i(c);
               }

               TbsLog.i("TbsDownload", "in response decoupleCoreVersion is " + var34);
               var5.mSyncMap.put("tbs_decouplecoreversion", var34);
               var5.mSyncMap.put("tbs_downloaddecouplecore", var35);
               if (!TbsShareManager.isThirdPartyApp(c)) {
                  if (var34 > 0 && var34 != o.a().i(c) && var34 == o.a().j(c)) {
                     o.a().o(c);
                  } else if (var34 == 0) {
                     try {
                        File var36 = o.a().q(c);
               ...
               if (TextUtils.isEmpty(var9) && TbsShareManager.isThirdPartyApp(c)) {
                  ...
                  if (var8 == 0) {
                     ...
                     int var54 = TbsDownloadConfig.getInstance(c).mPreferences.getInt("tbs_download_version", 0);
                     if (var54 > var11) {
                        g.c();
                        o.a().p(c);
                     }
                     ...
                     if (!TbsShareManager.isThirdPartyApp(c)) {
                        ...
                        TbsLog.i("TbsDownload", "tmpCoreVersion is " + var38 + " tbsDownloadVersion is" + var11);
                     }

                     if ((var1 >= var11 || TextUtils.isEmpty(var9) || var37) && var35 != 1) {
                        var5.mSyncMap.put("tbs_needdownload", false);
                        if (var2) {
                           ...
                           var5.mSyncMap.put("tbs_download_interrupt_code_reason", Integer.valueOf(var56));
                           var5.setDownloadInterruptCode(var56);
                        }

                        var5.commit();
                        TbsLog.i("TbsDownload", "version error or downloadUrl empty ,return ahead tbsLocalVersion=" + var1 + " tbsDownloadVersion=" + var11 + " tbsLastDownloadVersion=" + var54 + " downloadUrl=" + var9);
                        return false;
                     } else {
                        ...
                        if (var11 > 0) {
                           ...
                           TbsLog.i("TbsDownload", "put KEY_TBS_DOWNLOAD_V_TYPE is " + var35);
                        }
                        ...
                        var5.commit();
                        if (var50 != null) {
                           var5.mSyncMap.put("tbs_apk_md5", var50);
                        }

                        if (!var3 && var4 && o.a().b(c, var11)) {
                           if (var2) {
                           ...
                           TbsLogReport.TbsLogInfo var55;
                           if (!var3 && var4 && g.a(var3, var8 == 1 || var8 == 2)) {
                              var5.mSyncMap.put("tbs_needdownload", false);
                              var55 = TbsLogReport.getInstance(c).tbsLogInfo();
                              var55.setErrorCode(100);
                              var55.setFailDetail("use local backup apk in needDownload" + g.a);
                              if (a(c)) {
                                 TbsLogReport.getInstance(c).eventReport(TbsLogReport.EventType.TYPE_DOWNLOAD_DECOUPLE, var55);
                              } else {
                                 TbsLogReport.getInstance(c).eventReport(TbsLogReport.EventType.TYPE_DOWNLOAD, var55);
                              }
                              ...
                              var55 = TbsLogReport.getInstance(c).tbsLogInfo();
                              var55.setErrorCode(100);
                              var55.setFailDetail("installDecoupleCoreFromBackup" + g.a);
                              if (a(c)) {
                                 TbsLogReport.getInstance(c).eventReport(TbsLogReport.EventType.TYPE_DOWNLOAD_DECOUPLE, var55);
                              } else {
                                 TbsLogReport.getInstance(c).eventReport(TbsLogReport.EventType.TYPE_DOWNLOAD, var55);
   ...
   protected static File a(int var0) {
      ...
      for(int var5 = 0; var5 < var4; ++var5) {
         ...
         if (!var6.equals(c.getApplicationInfo().packageName)) {
            var2 = new File(FileUtil.a(c, var6, 4, false), getOverSea(c) ? "x5.oversea.tbs.org" : getBackupFileName(false));
            if (var2 != null && var2.exists()) {
               if (ApkUtil.getApkVersion(c, var2) == var0) {
   ...
   protected static File b(int var0) {
      ...
      for(int var5 = 0; var5 < var4; ++var5) {
         String var6 = var3[var5];
         var2 = new File(FileUtil.a(c, var6, 4, false), getOverSea(c) ? "x5.oversea.tbs.org" : getBackupFileName(false));
         if (var2 != null && var2.exists() && ApkUtil.getApkVersion(c, var2) == var0) {
            TbsLog.i("TbsDownload", "local tbs version fond,path = " + var2.getAbsolutePath());
            break;
         }

         var2 = new File(FileUtil.a(c, var6, 4, false), "x5.tbs.decouple");
         if (var2 != null && var2.exists() && ApkUtil.getApkVersion(c, var2) == var0) {
            TbsLog.i("TbsDownload", "local tbs version fond,path = " + var2.getAbsolutePath());
            break;
         }
   ...
   private static JSONArray a(boolean var0) {
      ...
      for(int var5 = 0; var5 < var4; ++var5) {
         ...
         File var7 = null;
         if (var0) {
            var7 = new File(FileUtil.a(c, var6, 4, false), getOverSea(c) ? "x5.oversea.tbs.org" : getBackupFileName(false));
         } else {
            var7 = new File(FileUtil.a(c, var6, 4, false), "x5.tbs.decouple");
         }

         if (var7 != null && var7.exists()) {
            long var8 = (long) ApkUtil.getApkVersion(c, var7);
            if (var8 > 0L) {
               boolean var10 = false;
