...
class o {
   ...
   private o() {
      if (m == null) {
         m = new Handler(com.tencent.smtt.sdk.n.a().getLooper()) {
            public void handleMessage(Message var1) {
               ...
               case 1:
                  ...
                  o.this.installTbsCoreInThread((Context)var2[0], (String)var2[1], (Integer)var2[2]);
                  break;
               case 2:
                  TbsLog.i("TbsInstaller", "TbsInstaller--handleMessage--MSG_COPY_TBS_CORE");
                  var2 = (Object[])((Object[])var1.obj);
                  o.this.a((Context)var2[0], (Context)var2[1], (Integer)var2[2]);
                  break;
               case 3:
                  TbsLog.i("TbsInstaller", "TbsInstaller--handleMessage--MSG_INSTALL_TBS_CORE_EX");
                  var2 = (Object[])((Object[])var1.obj);
                  o.this.b((Context)var2[0], (Bundle)var2[1]);
                  break;
               case 4:
                  TbsLog.i("TbsInstaller", "TbsInstaller--handleMessage--MSG_UNZIP_TBS_CORE");
                  var2 = (Object[])((Object[])var1.obj);
                  o.this.b((Context)var2[0], (File)var2[1], (Integer)var2[2]);
   ...
   private synchronized boolean c(Context var1, boolean var2) {
      ...
      try {
         ...
         boolean var4 = i.tryLock();
         TbsLog.i("TbsInstaller", "TbsInstaller-enableTbsCoreFromTpatch Locked =" + var4);
         if (var4) {
            try {
               int var5 = com.tencent.smtt.sdk.m.a(var1).b("tpatch_status");
         ...
         QbSdk.a(var1, "TbsInstaller::enableTbsCoreFromTpatch exception:" + Log.getStackTraceString(var11));
      }
   ...
   private synchronized boolean d(Context var1, boolean var2) {
      ...
      try {
         try {
            ...
            if (var4) {
               try {
                  int var5 = com.tencent.smtt.sdk.m.a(var1).b("copy_status");
                  int var6 = this.a(false, var1);
            ...
            QbSdk.a(var1, "TbsInstaller::enableTbsCoreFromCopy exception:" + Log.getStackTraceString(var16));
         }
   ...
   private synchronized boolean enableTbsCoreFromUnzip(Context var1, boolean var2) {
      boolean var3 = false;
      ...
      try {
         ...
         if (var4) {
            try {
               int var5 = com.tencent.smtt.sdk.m.a(var1).c();
         ...
         QbSdk.a(var1, "TbsInstaller::enableTbsCoreFromUnzip Exception: " + var11);
   ...
   void a(Context var1, boolean var2) {
      ...
      if (this.u(var1)) {
         ...
         int var6 = -1;
         int var7 = 0;
         boolean var8 = i.tryLock();
         if (var8) {
            try {
               var3 = com.tencent.smtt.sdk.m.a(var1).c();
               var4 = com.tencent.smtt.sdk.m.a(var1).b();
               var5 = com.tencent.smtt.sdk.m.a(var1).d("install_apk_path");
               var7 = com.tencent.smtt.sdk.m.a(var1).c("copy_core_ver");
               var6 = com.tencent.smtt.sdk.m.a(var1).b("copy_status");
            } finally {
               i.unlock();
            }
         }
         ...
         if (TbsShareManager.isThirdPartyApp(var1)) {
            ...
            if (var3 > -1 && var3 < 2) {
               this.installTbsCore(var1, var5, var4);
            }
   ...
   public static void a(Context var0) {
      if (!w(var0)) {
         if (isPrepareTbsCore(var0, "core_unzip_tmp")) {
         ...
         } else if (isPrepareTbsCore(var0, "core_share_backup_tmp")) {
         ...
         } else if (isPrepareTbsCore(var0, "core_copy_tmp")) {
   ...
   void b(Context var1, boolean var2) {
      if (!QbSdk.b) {
         if (VERSION.SDK_INT < 8) {
            ...
            if (TbsShareManager.isThirdPartyApp(var1) && com.tencent.smtt.sdk.m.a(var1).b("remove_old_core") == 1 && var2) {
               File var3 = a().r(var1);
   ...
   public int b(Context var1) {
      if (w(var1)) {
         if (isPrepareTbsCore(var1, "core_unzip_tmp")) {
            return -1;
         } else if (isPrepareTbsCore(var1, "core_share_backup_tmp")) {
            return -2;
         } else if (isPrepareTbsCore(var1, "core_copy_tmp")) {
            return -3;
         } else {
            return isPrepareTbsCore(var1, "tpatch_tmp") ? -4 : 1;
         }
      } else {
         return 0;
      }
   ...
   static boolean isPrepareTbsCore(Context var0, String var1) {
   ...
   void installTbsCore(Context var1, String var2, int var3) {
   ...
   @TargetApi(11)
   private void installTbsCoreInThread(Context var1, String tbsPath, int version) {
      boolean var4 = false;
      TbsDownloadConfig.getInstance(var1).setInstallInterruptCode(-501);
      if (this.isTbsLocalInstalled(var1)) {
         ...
         TbsLog.i("TbsInstaller", "TbsInstaller-installTbsCoreInThread tbsApkPath=" + tbsPath);
         TbsLog.i("TbsInstaller", "TbsInstaller-installTbsCoreInThread tbsCoreTargetVer=" + version);
         TbsLog.i("TbsInstaller", "TbsInstaller-continueInstallTbsCore currentProcessName=" + var1.getApplicationInfo().processName);
         ...
         if (var6 == version) {
            TbsLog.e("TbsInstaller", "TbsInstaller-installTbsCoreInThread -- version:" + version + " is disabled by preload_x5_check!");
            TbsDownloadConfig.getInstance(var1).setInstallInterruptCode(-503);
            QbSdk.m.onInstallFinish(-503);
         } else if (!FileUtil.b(var1)) {
            long var55 = com.tencent.smtt.utils.p.a();
            ...
            String var57 = "rom is not enough when installing tbs core! curAvailROM=" + var55 + ",minReqRom=" + var56;
            TbsLogReport.getInstance(var1).setInstallErrorCode(210, (String)var57);
            TbsLog.i("TbsInstaller", var57);
            ...
            if (var7) {
               ...
               try {
                  int var8 = com.tencent.smtt.sdk.m.a(var1).c("copy_core_ver");
                  int var9 = com.tencent.smtt.sdk.m.a(var1).b();
                  ...
                  TbsLog.i("TbsInstaller", "TbsInstaller-installTbsCoreInThread tbsCoreTargetVer =" + version);
                  if (var9 > 0 && version > var9 || var8 > 0 && version > var8) {
                     this.p(var1);
                  }

                  boolean var10 = false;
                  int var11 = com.tencent.smtt.sdk.m.a(var1).c();
                  int var12 = this.j(var1);
                  ...
                  } else if (var11 == 3 && var12 >= 0 && (version > var12 || version == 88888888)) {
                     var11 = -1;
                     this.p(var1);
                  ...
                  if (var11 < 1) {
                     ...
                     if (var10) {
                        var14 = com.tencent.smtt.sdk.m.a(var1).c("unzip_retry_num");
                        if (var14 > 10) {
                        ...
                        com.tencent.smtt.sdk.m.a(var1).b(var14 + 1);
                     }

                     var58 = tbsPath;
                     if (tbsPath == null) {
                        var58 = com.tencent.smtt.sdk.m.a(var1).d("install_apk_path");
                        if (var58 == null) {
                     ...
                     TbsLog.i("TbsInstaller", "TbsInstaller-installTbsCoreInThread apkPath =" + var58);
                     var13 = this.c(var1, var58);
                     if (var13 == 0) {
                     ...
                     int var15;
                     if (var10) {
                        var15 = com.tencent.smtt.sdk.m.a(var1).b("unlzma_status");
                        if (var15 > 5) {
                     ...
                     if (var16 != 0) {
                        ...
                        if (var18) {
                           ...
                           if (TbsDownloader.a(var1)) {
                              var19.putString("unzip_temp_path", this.q(var1).getAbsolutePath());
                           } else {
                              var19.putString("unzip_temp_path", this.f(var1, 0).getAbsolutePath());
                           }
                     ...
                     com.tencent.smtt.sdk.m.a(var1).c(var13, 1);
                  ...
                  if (var10) {
                     var14 = com.tencent.smtt.sdk.m.a(var1).c("dexopt_retry_num");
                     if (var14 > 10) {
                     ...
                     com.tencent.smtt.sdk.m.a(var1).a(var14 + 1);
                  }

                  TbsDownloadConfig.getInstance(var1).setInstallInterruptCode(-549);
                  if (this.doTbsDexOpt(var1, 0)) {
                     com.tencent.smtt.sdk.m.a(var1).c(var13, 2);
                     TbsLog.i("TbsInstaller", "STEP 2/2 installation completed! you can restart!", true);
                     TbsLog.i("TbsInstaller", "STEP 2/2 installation completed! you can restart! version:" + version);
                     ...
                     try {
                        Editor var59 = var5.edit();
                        var59.putInt("tbs_preload_x5_counter", 0);
                        var59.putInt("tbs_preload_x5_recorder", 0);
                        var59.putInt("tbs_preload_x5_version", version);
                        var59.commit();
                     ...
                     if (version == 88888888) {
                        this.a(version, tbsPath, var1);
                     }

                     if (this.k) {
                        TbsLogReport.getInstance(var1).setInstallErrorCode(this.v(var1), "continueInstallWithout core success");
                     } else {
                        TbsLogReport.getInstance(var1).setInstallErrorCode(this.v(var1), "success");
                     }
   ...
   private int v(Context var1) {
      boolean var2 = com.tencent.smtt.sdk.m.a(var1).d() == 1;
   ...
   public void c(Context var1) {
      this.g(var1, true);
      com.tencent.smtt.sdk.m.a(var1).c(this.i(var1), 2);
   }

   public void a(Context var1, int var2) {
      this.g(var1, true);
      com.tencent.smtt.sdk.m.a(var1).c(var2, 2);
   }

   boolean isTbsLocalInstalled(Context var1) {
      boolean var2 = false;
      File var3 = this.r(var1);
      File var4 = new File(var3, "tbs.conf");
      if (var4 != null && var4.exists()) {
   ...
   private static boolean w(Context var0) {
      if (var0 == null) {
   ...
   void b(Context var1, Bundle var2) {
      ...
      if (this.isTbsLocalInstalled(var1)) {
         ...
         if (var2 != null && var1 != null) {
            if (!FileUtil.b(var1)) {
               long var22 = com.tencent.smtt.utils.p.a();
                     ...
                     label468: {
                        label486: {
                           label470: {
                              try {
                                 ...
                                 if (var4 == 5) {
                                    ...
                                    if (var6 == 1) {
                                       int var24 = com.tencent.smtt.sdk.m.a(var1).c("tpatch_num");
                                       com.tencent.smtt.sdk.m.a(var1).a("tpatch_num", var24 + 1);
                                       var19 = false;
                                    } else {
                                       var19 = false;
                                    }
                                 ...
                                 String var11;
                                 label443: {
                                    if (this.j(var1) > 0 && com.tencent.smtt.sdk.m.a(var1).d() != 1) {
                                       ...
                                       if (var4 != 0) {
                                          var8 = com.tencent.smtt.sdk.m.a(var1).c("incrupdate_retry_num");
                                          if (var8 <= 5) {
                                             com.tencent.smtt.sdk.m.a(var1).a("incrupdate_retry_num", var8 + 1);
                                             File var26 = t(var1);
                                             if (var26 != null) {
                                 ...
                                 if (!TextUtils.isEmpty(var10)) {
                                    FileUtil.b(new File(var10));
                                 }

                                 if (!TextUtils.isEmpty(var11)) {
                                    FileUtil.b(new File(var11));
                                 }
                                 ...
                                 if (var19) {
                                    ...
                                    if (var6 == 0) {
                                       ...
                                       com.tencent.smtt.sdk.m.a(var1).a("incrupdate_retry_num", 0);
                                       TbsDownloadConfig.getInstance(var1).setInstallInterruptCode(-544);
                                       com.tencent.smtt.sdk.m.a(var1).c(0, -1);
                                       com.tencent.smtt.sdk.m.a(var1).c(1);
                                       String var15 = var5.getString("apk_path");
                                       com.tencent.smtt.sdk.l.backupTbsApk(new File(var15), var1);
                                       int var16 = var5.getInt("tbs_core_ver");
                                       this.installTbsCoreInThread(var1, var15, var16);
                                       if (TbsDownloader.a(var1)) {
                                          com.tencent.smtt.sdk.m.a(var1).c(-1);
                                       }
                                    } else if (var6 == 2) {
                              ...
                              if (var6 == 0) {
                                 ...
                                 com.tencent.smtt.sdk.l.backupTbsApk(new File(var12), var1);
                                 int var13 = var5.getInt("tbs_core_ver");
                                 this.installTbsCoreInThread(var1, var12, var13);
                                 if (TbsDownloader.a(var1)) {
                                    com.tencent.smtt.sdk.m.a(var1).c(-1);
                                 }
                              } else if (var6 == 2) {
                           ...
                           if (var6 == 0) {
                              ...
                              com.tencent.smtt.sdk.l.backupTbsApk(new File(var25), var1);
                              var8 = var5.getInt("tbs_core_ver");
                              this.installTbsCoreInThread(var1, var25, var8);
                              if (TbsDownloader.a(var1)) {
                                 com.tencent.smtt.sdk.m.a(var1).c(-1);
                              }
                           } else if (var6 == 2) {
   ...
   private void h(Context var1, int var2) {
      ...
      case 0:
         if (TbsDownloader.a(var1)) {
            ...
            com.tencent.smtt.sdk.m.a(var1).b(var3, 1);
         }
      case 1:
      case 2:
      default:
   ...
   private int c(Context var1, Bundle var2) {
      ...
      try {
         ...
         var4 = 1;
         TbsLogReport.getInstance(var1).setInstallErrorCode(239, (String)("patch exception" + Log.getStackTraceString(var9)));
      }
         ...
         if (var3 != var2) {
            ...
            if (var4 == null && TbsShareManager.getHostCorePathAppDefined() == null) {
               if (var3 <= 0) {
                  ...
                  QbSdk.a(var1, "TbsInstaller::installTbsCoreForThirdPartyApp forceSysWebViewInner #2");
               }
            } else {
   ...
   private void a(Context var1, Context var2, int var3) {
      ...
      if (!this.isTbsLocalInstalled(var2)) {
         ...
         if (var5 == var3) {
            ...
            if (var6) {
               ...
               try {
                  int var8 = com.tencent.smtt.sdk.m.a(var2).c("copy_core_ver");
                  int var9 = com.tencent.smtt.sdk.m.a(var2).b("copy_status");
                  if (var8 == var3) {
                  ...
                  int var11 = com.tencent.smtt.sdk.m.a(var2).b();
                  ...
                  long var14;
                  if (!FileUtil.b(var2)) {
                     long var54 = com.tencent.smtt.utils.p.a();
                  ...
                  if (var9 > 0 && (TbsShareManager.isThirdPartyApp(var2) || !TbsDownloader.a(var2) || var3 == this.i(var2))) {
                     TbsLog.i("TbsInstaller", "TbsInstaller-copyTbsCoreInThread return have copied is " + this.i(var2));
                     return;
                  }

                  if (var9 == 0) {
                     int var12 = com.tencent.smtt.sdk.m.a(var2).c("copy_retry_num");
                     if (var12 > 2) {
                     ...
                     com.tencent.smtt.sdk.m.a(var2).a("copy_retry_num", var12 + 1);
                  }

                  File var53 = this.r(var1);
                  ...
                  if (var53 != null && var7 != null) {
                     com.tencent.smtt.sdk.m.a(var2).a(var3, 0);
                     com.tencent.smtt.utils.o var13 = new com.tencent.smtt.utils.o();
                     var13.a(var53);
                     var14 = System.currentTimeMillis();
                     TbsDownloadConfig.getInstance(var1).setInstallInterruptCode(-551);
                     boolean var16 = FileUtil.a(var53, var7, c);
                     if (TbsDownloader.a(var2)) {
                     ...
                     if (var16) {
                        ...
                        this.g(var2, true);
                        var22 = com.tencent.smtt.sdk.l.b(var1);
                        if (var22 != null && var22.exists()) {
                           ...
                           com.tencent.smtt.sdk.l.backupTbsApk(var56, var2);
                        }

                        com.tencent.smtt.sdk.m.a(var2).a(var3, 1);
                        if (this.k) {
                        ...
                        com.tencent.smtt.utils.p.a(var2);
                     } else {
                        TbsLog.i("TbsInstaller", "TbsInstaller-copyTbsCoreInThread fail!");
                        com.tencent.smtt.sdk.m.a(var2).a(var3, 2);
                        FileUtil.a(var7, false);
                  ...
                  try {
                     FileUtil.a(var7, false);
                     com.tencent.smtt.sdk.m.a(var2).a(0, -1);
   ...
   public void b(Context var1, File var2, int var3) {
      FileOutputStream var4 = FileUtil.b(var1, true, "core_unzip.lock");
      FileLock var5 = FileUtil.a(var1, var4);
      if (var5 != null) {
         ...
         FileUtil.freeFileLock(var5, var4);
      } else {
      ...
      if (!FileUtil.c(var2)) {
         ...
         if (var4 == null) {
            ...
            try {
               boolean var7;
               try {
                  FileUtil.mkdirs(var4);
                  if (var3) {
                     FileUtil.a(var4, true);
                  }

                  boolean var6 = FileUtil.unzip(var2, var4);
                  if (var6) {
                     var6 = this.finalCheckForTbsCoreValidity(var4, var1);
                  }
                  ...
                  if (!var6) {
                     ...
                     this.g(var1, true);
                     if (var3) {
                        File var29 = this.q(var1);
                        FileUtil.a(var29, true);
                        var4.renameTo(var29);
   ...
   private boolean finalCheckForTbsCoreValidity(File var1, Context var2) {
   ...
   public boolean f(Context var1) {
      try {
         File var2 = new File(FileUtil.a(var1, 4), TbsDownloader.getBackupFileName(true));
         File var3 = a().f(var1, 2);
         FileUtil.mkdirs(var3);
         FileUtil.a(var3, true);
         FileUtil.unzip(var2, var3);
   ...
   private void i(Context var1, int var2) {
      File var3 = a().f(var1, var2);
      a().g(var1, true);
      File var4 = this.q(var1);
      FileUtil.a(var4, true);
      var3.renameTo(var4);
      TbsShareManager.b(var1);
   }

   private boolean doTbsDexOpt(Context var1, int var2) {
      ...
      try {
         ...
         try {
            ...
            TbsLogReport.getInstance(var1).setInstallErrorCode(226, (Throwable)var8);
         }

         boolean var10 = VERSION.SDK_INT == 23;
         boolean var6 = TbsDownloadConfig.getInstance(var1).mPreferences.getBoolean("tbs_stop_preoat", false);
         boolean var7 = var4 && var10 && !var6;
         if (var7 && this.c(var1, var3)) {
         ...
         var9.printStackTrace();
         TbsLogReport.getInstance(var1).setInstallErrorCode(209, (String)var9.toString());
      }
   ...
   private boolean x(Context var1) {
   ...
   private void generateNewTbsCoreFromUnzip(Context var1) {
      ...
      if (!this.x(var1)) {
         ...
         try {
            ...
            com.tencent.smtt.sdk.m.a(var1).a(0);
            com.tencent.smtt.sdk.m.a(var1).b(0);
            com.tencent.smtt.sdk.m.a(var1).d(0);
            com.tencent.smtt.sdk.m.a(var1).a("incrupdate_retry_num", 0);
            com.tencent.smtt.sdk.m.a(var1).c(0, 3);
            com.tencent.smtt.sdk.m.a(var1).a("");
            com.tencent.smtt.sdk.m.a(var1).a("tpatch_num", 0);
            com.tencent.smtt.sdk.m.a(var1).c(-1);
            if (!TbsShareManager.isThirdPartyApp(var1)) {
               int var2 = TbsDownloadConfig.getInstance(var1).mPreferences.getInt("tbs_decouplecoreversion", 0);
               if (var2 > 0 && var2 != a().i(var1) && var2 == a().j(var1)) {
                  this.o(var1);
               } else {
                  TbsLog.i("TbsInstaller", "TbsInstaller--generateNewTbsCoreFromUnzip #1 deCoupleCoreVersion is " + var2 + " getTbsCoreShareDecoupleCoreVersion is " + a().i(var1) + " getTbsCoreInstalledVerInNolock is " + a().j(var1));
               }
            }

            if (TbsShareManager.isThirdPartyApp(var1)) {
               TbsShareManager.writeCoreInfoForThirdPartyApp(var1, this.n(var1), true);
            }
   ...
   private void z(Context var1) {
      ...
      if (!this.x(var1)) {
         ...
         try {
            ...
            com.tencent.smtt.sdk.m.a(var1).b(0, -1);
            com.tencent.smtt.sdk.m.a(var1).a("tpatch_num", 0);
            a.set(0);
         } catch (Exception var3) {
            var3.printStackTrace();
   ...
   private void A(Context var1) {
      ...
      if (!this.x(var1)) {
         ...
         try {
            ...
            com.tencent.smtt.sdk.m.a(var1).a(0, 3);
            com.tencent.smtt.sdk.m.a(var1).a("tpatch_num", 0);
            if (!TbsShareManager.isThirdPartyApp(var1)) {
               int var2 = TbsDownloadConfig.getInstance(var1).mPreferences.getInt("tbs_decouplecoreversion", 0);
               if (var2 > 0 && var2 != a().i(var1) && var2 == a().j(var1)) {
                  ...
                  TbsLog.i("TbsInstaller", "TbsInstaller--generateNewTbsCoreFromCopy #1 deCoupleCoreVersion is " + var2 + " getTbsCoreShareDecoupleCoreVersion is " + a().i(var1) + " getTbsCoreInstalledVerInNolock is " + a().j(var1));
               }
            }
   ...
   int e(Context var1, int var2) {
      File var3 = this.f(var1, var2);
      return this.a(var3);
   }
   ...
   int a(File var1) {
      ...
      try {
         byte var5;
         try {
            TbsLog.i("TbsInstaller", "TbsInstaller--getTbsVersion  tbsShareDir is " + var1);
            File var4 = new File(var1, "tbs.conf");
            if (var4 != null && var4.exists()) {
   ...
   public String d(Context var1, String var2) {
         ...
         if (var2) {
            ...
            try {
               ...
               if (var29 != null && var29.exists()) {
                  ...
                  var30.load(var4);
                  var4.close();
                  String var8 = var30.getProperty("tbs_core_version");
                  if (var8 == null) {
                     byte var31 = 0;
                     return var31;
                  }
   ...
   private void F(Context var1) {
      ...
      File var2 = this.f(var1, 0);
      if (var2 != null) {
         FileUtil.a(var2, false);
      }

      com.tencent.smtt.sdk.m.a(var1).c(0, 5);
      com.tencent.smtt.sdk.m.a(var1).c(-1);
      QbSdk.a(var1, "TbsInstaller::clearNewTbsCore forceSysWebViewInner!");
   }
   ...
   void p(Context var1) {
      ...
      if (!TbsDownloader.a(var1)) {
         com.tencent.smtt.sdk.m.a(var1).c(0, -1);
         com.tencent.smtt.sdk.m.a(var1).a("");
         com.tencent.smtt.sdk.m.a(var1).a("copy_retry_num", 0);
         com.tencent.smtt.sdk.m.a(var1).c(-1);
         com.tencent.smtt.sdk.m.a(var1).a(0, -1);
         FileUtil.a(this.f(var1, 0), true);
         FileUtil.a(this.f(var1, 1), true);
      }

   }

   File b(Context var1, Context var2) {
      File var3 = QbSdk.getTbsFolderDir(var2);
      File var4 = new File(var3, "core_share");
      if (var4 == null) {
   ...
   File c(Context var1, Context var2) {
      File var3 = QbSdk.getTbsFolderDir(var2);
      File var4 = new File(var3, "core_share_decouple");
      if (var4 == null) {
         return null;
      } else {
         if (!var4.isDirectory() && (var1 == null || !TbsShareManager.isThirdPartyApp(var1))) {
   ...
   File r(Context var1) {
      return this.b((Context)null, (Context)var1);
   }

   File s(Context var1) {
      File var2 = QbSdk.getTbsFolderDir(var1);
      File var3 = new File(var2, "share");
      if (var3 != null) {
         if (!var3.isDirectory()) {
            boolean var4 = var3.mkdir();
            if (!var4) {
   ...
   File f(Context var1, int var2) {
      return this.a(var1, var2, true);
   }

   File a(Context var1, int var2, boolean var3) {
      ...
      case 1:
         ...
         break;
      case 2:
         var5 = "core_unzip_tmp_decouple";
         break;
      case 3:
         var5 = "core_share_backup";
         break;
      case 4:
         var5 = "core_share_backup_tmp";
         break;
      case 5:
         var5 = "tpatch_tmp";
         break;
      case 6:
         var5 = "tpatch_decouple_tmp";
      }

      TbsLog.i("TbsInstaller", "type=" + var2 + "needMakeDir=" + var3 + "folder=" + var5);
   ...
   synchronized boolean u(Context var1) {
      if (this.e > 0) {
         TbsLog.i("TbsInstaller", "getTbsInstallingFileLock success,is cached= true");
         ++this.e;
         return true;
      } else {
         this.g = FileUtil.b(var1, true, "tbslock.txt");
         if (this.g != null) {
            this.f = FileUtil.a(var1, this.g);
            if (this.f == null) {
   ...
   synchronized void b() {
      if (this.e <= 0) {
         ...
         if (this.e == 1) {
            ...
            FileUtil.freeFileLock(this.f, this.g);
            this.e = 0;
         }
   ...
   private boolean b(Context var1, File var2) {
      try {
         ...
         if (VERSION.SDK_INT < 16 && var1.getPackageName() != null && var1.getPackageName().equalsIgnoreCase("com.tencent.tbs")) {
            try {
               Thread.sleep(5000L);
            } catch (Exception var8) {
            }
   ...
   private boolean c(Context var1, File var2) {
      try {
         File var3 = new File(var2, "tbs_sdk_extension_dex.jar");
         File var4 = new File(var2, "tbs_sdk_extension_dex.dex");
         ClassLoader var5 = var1.getClassLoader();
         new DexClassLoader(var3.getAbsolutePath(), var2.getAbsolutePath(), (String)null, var5);
         String var6 = com.tencent.smtt.sdk.e.a(var1, var4.getAbsolutePath());
         if (TextUtils.isEmpty(var6)) {
            TbsLogReport.getInstance(var1).setInstallErrorCode(226, (String)"can not find oat command");
            return false;
         } else {
            ...
            for(int var11 = 0; var11 < var10; ++var11) {
               ...
               String var14 = var6.replaceAll("tbs_sdk_extension_dex", var13);
               String var15 = "/system/bin/dex2oat " + var14 + " --dex-location=" + a().r(var1) + File.separator + var13 + ".jar";
         ...
         var17.printStackTrace();
         TbsLogReport.getInstance(var1).setInstallErrorCode(226, (Throwable)var17);
         return false;
      }
   }
}
