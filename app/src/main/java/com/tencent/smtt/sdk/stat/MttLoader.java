...
public class MttLoader {
   ...
   public static int loadUrl(Context var0, String var1, HashMap<String, String> var2, String var3, WebView var4) {
      ...
      var5.append("mttbrowser://url=").append(var1).append(",product=").append("TBS").append(",packagename=").append(var0.getPackageName()).append(",from=").append(var3).append(",version=").append("4.3.0.151").append(var11);
   ...
   public static boolean verifySignature(File var0) {
      ...
      try {
         ...
         String var6 = a(var5[0]);
         if (var6 == null || !var6.equals("")) {
            return false;
         }
