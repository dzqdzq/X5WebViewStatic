...
public class QbSdk {
      ...
      if (var3 == null) {
         try {
            ...
            if (var6 == "com.tencent.mm" || var6 == "com.tencent.mobileqq") {
               X5CoreEngine var7 = X5CoreEngine.a();
               if (null != var7 && var7.b()) {
                  DexLoader var8 = var7.c().b();
   ...
   private static boolean a(Context var0, boolean var1) {
      ...
      if (!sIsVersionPrinted) {
         TbsLog.i("QbSdk", "svn revision: jnizz; SDK_VERSION_CODE: 44051; SDK_VERSION_NAME: 4.3.0.151");
      ...
      if (a && !var1) {
         ...
         try {
            File var2 = com.tencent.smtt.sdk.o.a().r(var0);
            if (var2 == null) {
               ...
               if (TbsShareManager.isThirdPartyApp(var0)) {
                  ...
                  int var3 = 0;
                  if (o != 0) {
                     var3 = com.tencent.smtt.sdk.o.a().a(true, var0);
                     if (o != var3) {
                        q = null;
                        r = null;
               ...
               if (TbsDownloader.a(var0, o)) {
                  ...
                  if (TbsShareManager.isThirdPartyApp(var0)) {
                     ...
                     var9 = new File(TbsShareManager.c(var0), "tbs_sdk_extension_dex.jar");
                  } else {
                     var4 = com.tencent.smtt.sdk.o.a().r(var0);
                     var9 = new File(var4, "tbs_sdk_extension_dex.jar");
                  }

                  if (!var9.exists()) {
                     try {
                        TbsLog.e("QbSdk", "QbSdk init (false) tbs_sdk_extension_dex.jar is not exist!");
                        int var12 = com.tencent.smtt.sdk.o.a().j(var0);
                        File var11 = new File(var9.getParentFile(), "tbs_jars_fusion_dex.jar");
                        if (var11.exists()) {
                           if (var12 > 0) {
                              TbsCoreLoadStat.getInstance().a(var0, 4131, new Exception("tbs_sdk_extension_dex not exist(with fusion dex)!" + var12));
                           } else {
                              TbsCoreLoadStat.getInstance().a(var0, 4132, new Exception("tbs_sdk_extension_dex not exist(with fusion dex)!" + var12));
                           }
                        } else if (var12 > 0) {
                           TbsCoreLoadStat.getInstance().a(var0, 4121, new Exception("tbs_sdk_extension_dex not exist(without fusion dex)!" + var12));
                        } else {
                           TbsCoreLoadStat.getInstance().a(var0, 4122, new Exception("tbs_sdk_extension_dex not exist(without fusion dex)!" + var12));
                        }
                     ...
                     if (TbsShareManager.getHostCorePathAppDefined() != null) {
                        var10 = TbsShareManager.getHostCorePathAppDefined();
                     } else {
                        var10 = var2.getAbsolutePath();
                     }

                     TbsLog.i("QbSdk", "QbSdk init optDirExtension #1 is " + var10);
                     TbsLog.i("QbSdk", "new DexLoader #1 dexFile is " + var9.getAbsolutePath());
                     X5CoreEngine.a().b(var0);
                     TbsCheckUtils.a(var0);
                     DexLoader var5 = new DexLoader(var9.getParent(), var0, new String[]{var9.getAbsolutePath()}, var10, getSettings());
                     q = var5.loadClass("com.tencent.tbs.sdk.extension.TbsSDKExtension");
                     if (!isEnableSensitiveApi()) {
                        Object var6 = com.tencent.smtt.utils.i.a(q, "isSuiteableGetSensitative", new Class[0]);
                        if (var6 == null) {
                     ...
                     loadTBSSDKExtension(var0, var9.getParent());
            ...
            TbsLog.e("QbSdk", "QbSdk init Throwable: " + Log.getStackTraceString(var8));
            TbsCoreLoadStat.getInstance().a(var0, 306, var8);
            return false;
         }
      }
   }
   ...
   public static void initForinitAndNotLoadSo(Context var0) {
      if (q == null) {
         File var1 = com.tencent.smtt.sdk.o.a().r(var0);
         if (var1 == null) {
   ...
   public static boolean canLoadX5FirstTimeThirdApp(Context var0) {
      try {
         if (var0.getApplicationInfo().packageName.contains("com.moji.mjweather") && android.os.Build.VERSION.SDK_INT == 19) {
            ...
            Object var8 = com.tencent.smtt.utils.i.a(r, "canLoadX5CoreForThirdApp", new Class[0]);
            return var8 != null && var8 instanceof Boolean ? (Boolean)var8 : false;
         }
      } catch (Throwable var7) {
         TbsLog.e("QbSdk", "canLoadX5FirstTimeThirdApp sys WebView: " + Log.getStackTraceString(var7));
         return false;
      }
   }
   ...
   static boolean a(Context var0) {
      try {
         if (q != null) {
            ...
            if (var1 == null) {
               ...
               if (!var2.exists()) {
                  ...
                  if (!isEnableSensitiveApi()) {
                     Object var4 = com.tencent.smtt.utils.i.a(q, "isSuiteableGetSensitative", new Class[0]);
                     if (var4 == null) {
                        TbsLog.e("QbSdk", "isSuiteableGetSensitative check failed,can not use x5");
                        return false;
                     }
         ...
         TbsLog.e("QbSdk", "initExtension sys WebView: " + Log.getStackTraceString(var5));
         return false;
      }
   }
   ...
   private static boolean c(Context var0) {
      try {
         if (q != null) {
            ...
            if (var1 == null) {
               ...
               if (TbsShareManager.isThirdPartyApp(var0)) {
                  ...
                  var3 = com.tencent.smtt.sdk.o.a().r(var0);
               ...
               if (!var2.exists()) {
                  ...
                  String var7;
                  if (TbsShareManager.getHostCorePathAppDefined() != null) {
                     var7 = TbsShareManager.getHostCorePathAppDefined();
                  } else {
                     var7 = var1.getAbsolutePath();
                  }

                  TbsLog.i("QbSdk", "QbSdk init optDirExtension #3 is " + var7);
                  TbsLog.i("QbSdk", "new DexLoader #4 dexFile is " + var2.getAbsolutePath());
                  X5CoreEngine.a().b(var0);
                  TbsCheckUtils.a(var0);
                  DexLoader var4 = new DexLoader(var2.getParent(), var0, new String[]{var2.getAbsolutePath()}, var7, getSettings());
                  q = var4.loadClass("com.tencent.tbs.sdk.extension.TbsSDKExtension");
                  if (!isEnableSensitiveApi()) {
                     Object var5 = com.tencent.smtt.utils.i.a(q, "isSuiteableGetSensitative", new Class[0]);
                     if (var5 == null) {
                        TbsLog.e("QbSdk", "isSuiteableGetSensitative check failed,can not use x5");
                        return false;
                     }
         ...
         TbsLog.e("QbSdk", "initForX5DisableConfig sys WebView: " + Log.getStackTraceString(var6));
         return false;
      }
   }
   ...
   static Bundle a(Context var0, Bundle var1) throws Exception {
      if (!a(var0)) {
         ...
         Object var2 = com.tencent.smtt.utils.i.a(r, "incrUpdate", new Class[]{Context.class, Bundle.class}, var0, var1);
         if (var2 != null) {
            return (Bundle)var2;
         } else {
   ...
   static boolean a(Context var0, int var1, int var2) {
      if (n != null && n.containsKey("SET_SENDREQUEST_AND_UPLOAD") && n.get("SET_SENDREQUEST_AND_UPLOAD").equals("false")) {
         ...
         Object var3;
         if (!isEnableSensitiveApi()) {
            var3 = com.tencent.smtt.utils.i.a(q, "isSuiteableGetSensitative", new Class[0]);
            if (var3 == null) {
               TbsLog.e("QbSdk", "isSuiteableGetSensitative check failed,can not use x5");
               return false;
            }
         ...
         com.tencent.smtt.sdk.o.a().b(var0, SDKEngine.a == 0);
         if (!c(var0)) {
            return true;
         } else {
            var3 = com.tencent.smtt.utils.i.a(r, "isX5Disabled", new Class[]{Integer.TYPE, Integer.TYPE, Integer.TYPE}, var1, 44051, var2);
            if (var3 != null) {
               return (Boolean)var3;
            } else {
               var3 = com.tencent.smtt.utils.i.a(r, "isX5Disabled", new Class[]{Integer.TYPE, Integer.TYPE}, var1, 44051);
   ...
   public static boolean canOpenWebPlus(Context var0) {
      if (y == 0) {
         y = com.tencent.smtt.sdk.a.a();
      }

      TbsLog.i("QbSdk", "canOpenWebPlus - totalRAM: " + y);
      if (android.os.Build.VERSION.SDK_INT >= 7 && y >= z) {
         if (var0 == null) {
            return false;
         } else {
            boolean var1 = false;
            ...
            int var43;
            try {
               File var4 = new File(com.tencent.smtt.sdk.o.a().r(var0), "tbs.conf");
            ...
            try {
               File var47 = new File(com.tencent.smtt.sdk.o.t(var0), "tbs_extension.conf");
               ...
               if (var43 != 88888888 && var8 != 88888888) {
                  if (var43 > var8) {
                     ...
                     if (var9 > 0 && var9 != com.tencent.smtt.utils.AppUtil.d(var0)) {
                        var44 = false;
                     } else {
   ...
   public static boolean isX5DisabledSync(Context var0) {
      int var1 = com.tencent.smtt.sdk.m.a(var0).c();
      boolean var2 = var1 == 2;
      if (var2) {
         return false;
      } else if (!c(var0)) {
         ...
         int var3 = com.tencent.smtt.sdk.o.a().j(var0);
         Object var4 = com.tencent.smtt.utils.i.a(r, "isX5DisabledSync", new Class[]{Integer.TYPE, Integer.TYPE}, var3, 44051);
   ...
   public static boolean installLocalQbApk(Context var0, String var1, String var2, Bundle var3) {
      ...
      return null != var4 && var4.b() ? var4.a().a(var0, var1, var2, var3) : false;
   }

   public static boolean canUseVideoFeatrue(Context var0, int var1) {
      Object var2 = com.tencent.smtt.utils.i.a(r, "canUseVideoFeatrue", new Class[]{Integer.TYPE}, var1);
      return var2 != null && var2 instanceof Boolean ? (Boolean)var2 : false;
   }

   public static boolean canLoadVideo(Context var0) {
      Object var1 = com.tencent.smtt.utils.i.a(r, "canLoadVideo", new Class[]{Integer.TYPE}, 0);
      if (var1 != null) {
   ...
   static boolean a(Context var0, boolean var1, boolean var2) {
      ...
      if (var4 != 0 && var4 == com.tencent.smtt.sdk.o.a().j(var0)) {
         TbsLog.e("QbSdk", "force use sys by remote switch");
         return var3;
      } else {
         Object var5;
         if (!isEnableSensitiveApi()) {
            var5 = com.tencent.smtt.utils.i.a(r, "isSuiteableGetSensitative", new Class[0]);
            if (var5 == null) {
               TbsLog.e("QbSdk", "isSuiteableGetSensitative check failed,can not use x5");
               return false;
            }
         ...
         if (TbsShareManager.isThirdPartyApp(var0) && !TbsShareManager.i(var0)) {
            ...
            var5 = com.tencent.smtt.utils.i.a(r, "canLoadX5Core", new Class[]{Integer.TYPE}, 44051);
            if (var5 != null) {
               ...
               if (TbsShareManager.isThirdPartyApp(var0)) {
                  ...
                  if (var8) {
                     ...
                     File var9 = com.tencent.smtt.sdk.o.a().r(var0);
                     FileUtil.b(var9);
               ...
               if (var7 != 0) {
                  try {
                     var18 = com.tencent.smtt.utils.i.a(r, "getErrorCodeForLogReport", new Class[0]);
               ...
               var5 = com.tencent.smtt.utils.i.a(r, "canLoadX5", new Class[]{Integer.TYPE}, com.tencent.smtt.sdk.a.a());
               if (var5 != null) {
                  if (var5 instanceof String && ((String)var5).equalsIgnoreCase("AuthenticationFail")) {
                     return false;
                  }
   ...
   public static void setCurrentID(String var0) {
      if (var0 != null) {
         if (var0.startsWith("QQ:")) {
            ...
            A = var1.substring(var2.length()) + var2;
         }
   ...
   static synchronized void a(Context var0, String var1) {
      if (!a) {
         a = true;
         v = "forceSysWebViewInner: " + var1;
         TbsLog.e("QbSdk", "QbSdk.SysWebViewForcedInner..." + v);
         TbsCoreLoadStat.getInstance().a(var0, 401, new Throwable(v));
      }
   }
   ...
   public static void canOpenFile(final Context var0, final String var1, final ValueCallback<Boolean> var2) {
      (new Thread() {
         public void run() {
            X5CoreEngine var1x = X5CoreEngine.a();
            var1x.a(var0);
            final boolean var2x = var1x.b()?var1x.c().a(var0, var1):false;

            (new Handler(Looper.getMainLooper())).post(new Runnable() {
               public void run() {
                  var2.onReceiveValue(var2x);
               }
            });
         }
      }).start();
         ...
         final Handler var2 = new Handler(Looper.getMainLooper()) {
            public void handleMessage(Message var1x) {
               ...
               case 1:
                  ...
                  QbSdk.C = var2.canUseFunction(var0, "disable_unpreinit.txt");
                  if (QbSdk.j) {
                     WebCoreProxy var3 = X5CoreEngine.a().c();
                     if (var3 != null) {
                        var3.a(var0);
                     }
                  }
   ...
   public static boolean isTbsCoreInited() {
      SDKEngine var0 = SDKEngine.a(false);
      ...
      if (var0 == null) {
         ...
         F = new TbsListener() {
            public void onDownloadFinish(int var1x) {
               Log.e("QbSdk", "onDownloadFinish = " + var1x);
            }
   ...
   private static void d(Context var0) {
      ...
      try {
         ...
         var2 = com.tencent.smtt.sdk.o.a().j(var0);
         if (var2 <= 0) {
            var12 = true;
            return;
         }
      ...
      if (var6 > 3) {
         try {
            ...
            if (var13 == var2) {
               FileUtil.a(com.tencent.smtt.sdk.o.a().r(var0), false);
               File var8 = com.tencent.smtt.sdk.m.a(var0).a();
               if (var8 != null) {
                  FileUtil.a(var8, false);
               }
   ...
   public static int getTbsVersion(Context var0) {
      if (TbsShareManager.isThirdPartyApp(var0)) {
         ...
         int var1 = com.tencent.smtt.sdk.o.a().j(var0);
         return var1;
      }
   }
   ...
   public static int getTbsVersionForCrash(Context var0) {
      if (TbsShareManager.isThirdPartyApp(var0)) {
         ...
         int var1 = com.tencent.smtt.sdk.o.a().k(var0);
         if (var1 == 0 && com.tencent.smtt.sdk.m.a(var0).c() == 3) {
            reset(var0);
         }
   ...
   public static void continueLoadSo(Context var0) {
      if ("com.tencent.mm".equals(getCurrentProcessName(var0)) && WebView.mWebViewCreated) {
         com.tencent.smtt.utils.i.a(r, "continueLoadSo", new Class[0]);
      }
   ...
   public static boolean getJarFilesAndLibraryPath(Context var0) {
      if (r == null) {
         ...
         Object var1 = com.tencent.smtt.utils.i.a(r, "canLoadX5CoreAndNotLoadSo", new Class[]{Integer.TYPE}, 44051);
         Bundle var2 = (Bundle)var1;
         if (var2 == null) {
            TbsLog.i("QbSdk", "getJarFilesAndLibraryPath bundle is null and coreverison is " + com.tencent.smtt.sdk.o.a().a(true, var0));
            return false;
         } else {
   ...
   public static String[] getDexLoaderFileList(Context var0, Context var1, String var2) {
      if (!(t instanceof String[])) {
         Object var6 = com.tencent.smtt.utils.i.a(r, "getJarFiles", new Class[]{Context.class, Context.class, String.class}, var0, var1, var2);
   ...
   public static boolean useSoftWare() {
      if (r == null) {
         ...
         Object var0 = com.tencent.smtt.utils.i.a(r, "useSoftWare", new Class[0]);
         if (var0 == null) {
            var0 = com.tencent.smtt.utils.i.a(r, "useSoftWare", new Class[]{Integer.TYPE}, com.tencent.smtt.sdk.a.a());
         }
   ...
   public static void reset(Context var0, boolean var1) {
      ...
      try {
         ...
         if (var1 && !TbsShareManager.isThirdPartyApp(var0)) {
            int var3 = com.tencent.smtt.sdk.o.a().i(var0);
            int var4 = com.tencent.smtt.sdk.o.a().j(var0);
         ...
         FileUtil.a(var8, false, "core_share_decouple");
         TbsLog.i("QbSdk", "delete downloaded apk success", true);
         com.tencent.smtt.sdk.o.a.set(0);
         ...
         if (var2) {
            File var5 = com.tencent.smtt.sdk.o.a().q(var0);
            File var6 = com.tencent.smtt.sdk.o.a().f(var0, 0);
            FileUtil.b(var5, var6);
            com.tencent.smtt.sdk.o.a().c(var0);
         }
      } catch (Throwable var7) {
   ...
   public static void resetDecoupleCore(Context var0) {
      ...
      try {
         File var1 = com.tencent.smtt.sdk.o.a().q(var0);
         FileUtil.b(var1);
      ...
      if (var0 == null) {
         ...
         if (var4.b()) {
            if (var0 != null && var0.getApplicationInfo().packageName.equals("com.nd.android.pandahome2") && getTbsVersion(var0) < 25487) {
               ...
               int var5 = var4.c().a(var0, var1, var2, (String)null, var3);
               if (var5 == 0) {
   ...
   public static boolean startQbOrMiniQBToLoadUrl(Context var0, String var1, HashMap<String, String> var2, ValueCallback<String> var3) {
      if (var0 == null) {
         ...
         if (var2 != null && "5".equals(var2.get("PosID")) && var4.b()) {
            Bundle var8 = null;
            DexLoader var9 = var4.c().b();
         ...
         if (0 != var11) {
            if (var4.b()) {
               ...
               if (var4.c().a(var0, var1, var2, (String)null, var3) == 0) {
                  return true;
               }
            }
   ...
   public static int openFileReader(Context var0, String var1, HashMap<String, String> var2, ValueCallback<String> var3) {
      ...
      if (!checkContentProviderPrivilage(var0)) {
         ...
         String var4 = var1.substring(var1.lastIndexOf(".") + 1);
         String var5 = null;
         if (var4 != null) {
            var5 = var4.toLowerCase();
         }

         String var6 = (String)var2.get("fileext");
         ...
         if (var5 == null) {
            ...
            return -7;
         } else if ("apk".equalsIgnoreCase(var5)) {
            ...
            if (var8 == null) {
               ...
               var7.setDataAndType(var8, "application/vnd.android.package-archive");
            ...
            if (MttLoader.isBrowserInstalled(var0)) {
               ...
               if (startQBForDoc(var0, var1, 4, 0, var5, a(var0, (Map)var2))) {
                  if (var3 != null) {
            ...
            int var9 = startMiniQBToLoadUrl(var0, var1, var2, var3);
            if (var9 != 0) {
               openFileReaderListWithQBDownload(var0, var1, var3);
               TbsLogReport.getInstance(var0).setLoadErrorCode(511, (String)("" + var9));
               return 3;
            } else {
   ...
   public static String getMiniQBVersion(Context var0) {
      X5CoreEngine var1 = X5CoreEngine.a();
      var1.a(var0);
      return null != var1 && var1.b() ? var1.c().f() : null;
   }
   ...
   public static boolean intentDispatch(WebView var0, Intent var1, String var2, String var3) {
      if (var0 == null) {
         ...
         if (var2.startsWith("mttbrowser://miniqb/ch=icon?")) {
            ...
            if (0 != var11) {
               X5CoreEngine var12 = X5CoreEngine.a();
               if (null != var12 && var12.b() && var12.c().a(var4, var6, (Map)null, var3, (android.webkit.ValueCallback)null) == 0) {
                  return true;
               }
   ...
   public static void openFileReaderListWithQBDownload(Context var0, String var1, Bundle var2, final ValueCallback<String> var3) {
      if (var0 != null && !var0.getApplicationInfo().packageName.equals("com.tencent.qim") && !var0.getApplicationInfo().packageName.equals("com.tencent.androidqqmail")) {
         ...
         String var7 = com.tencent.smtt.sdk.ui.dialog.e.d(var1);
         if (var0 != null && var0.getApplicationInfo().targetSdkVersion >= 24 && android.os.Build.VERSION.SDK_INT >= 24) {
            var6.addFlags(1);
         }
   ...
   static Object a(Context var0, String var1, Bundle var2) {
      if (!a(var0)) {
         ...
         Object var3 = com.tencent.smtt.utils.i.a(r, "miscCall", new Class[]{String.class, Bundle.class}, var1, var2);
   ...
   static void a(Context var0, Integer var1, Map<Integer, String> var2) {
      if (a(var0)) {
         ...
         com.tencent.smtt.utils.i.a(r, "dispatchEmergencyCommand", var3, var4);
      }
   }
   ...
   public static int getTmpDirTbsVersion(Context var0) {
      if (com.tencent.smtt.sdk.m.a(var0).c() == 2) {
         return com.tencent.smtt.sdk.o.a().e(var0, 0);
      } else {
         return com.tencent.smtt.sdk.m.a(var0).b("copy_status") == 1 ? com.tencent.smtt.sdk.o.a().e(var0, 1) : 0;
      }
   }
   ...
   public static boolean isInDefaultBrowser(Context var0, String var1) {
      ...
      String var3 = com.tencent.smtt.sdk.ui.dialog.e.d(var1);
   ...
   public static void setNewDnsHostList(String var0) {
      ...
      if (null != var1 && var1.b()) {
         ...
         try {
            var2.invokeStaticMethod("com.tencent.tbs.tbsshell.WebCoreProxy", "setNewDnsHostList", new Class[]{String.class}, var0);
         } catch (Exception var4) {
            return;
         }
      }
   ...
   public static void installLocalTbsCore(Context var0, int var1, String var2) {
      com.tencent.smtt.sdk.o.a().installTbsCore(var0, var2, var1);
   }

   public static void disableSensitiveApi() {
      x = false;
      HashMap var0 = new HashMap();
      var0.put("no_sensitive_api", true);
      initTbsSettings(var0);
   }
   ...
   static {
      ...
      m = new TbsListener() {
         ...
         public void onDownloadProgress(int var1) {
            if (QbSdk.F != null) {
               QbSdk.F.onDownloadProgress(var1);
            }
