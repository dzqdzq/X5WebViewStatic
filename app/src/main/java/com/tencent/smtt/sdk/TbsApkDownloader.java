...
class l {
   ...
   private String tbs_downloadurl;
   private String j;
   private String k;
   private File l;
   private long m;
   ...
   public l(Context var1) throws NullPointerException {
      this.C = e;
      this.b = null;
      this.c = 0;
      ...
      com.tencent.smtt.sdk.o.a();
      this.l = com.tencent.smtt.sdk.o.t(this.context);
      if (this.l == null) {
   ...
   private void initHttpRequest(String var1) throws Exception {
      URL var2 = new URL(var1);
      if (this.u != null) {
         try {
            this.u.disconnect();
         } catch (Throwable var4) {
            TbsLog.e("TbsApkDownloader", "[initHttpRequest] mHttpRequest.disconnect() Throwable:" + var4.toString());
         }
      }
   ...
   private void closeHttpRequest() {
      TbsLog.i("TbsApkDownloader", "[TbsApkDownloader.closeHttpRequest]");
      if (this.u != null) {
         if (!this.s) {
            this.w.setResolveIp(this.getHostAddress(this.u.getURL()));
         }

         try {
            this.u.disconnect();
         } catch (Throwable var4) {
            TbsLog.e("TbsApkDownloader", "[closeHttpRequest] mHttpRequest.disconnect() Throwable:" + var4.toString());
         }
   ...
   private boolean copyTbsApkFromBackupToInstall(int var1) {
      try {
         ...
         File var3 = backupApkPath(this.context);
         if (var3 != null) {
            File var4 = new File(var3, TbsDownloader.getOverSea(this.context) ? "x5.oversea.tbs.org" : TbsDownloader.getBackupFileName(false));
            var2.delete();
            FileUtil.b(var4, var2);
            if (!ApkUtil.getApkVersion(this.context, var2, 0L, var1)) {
               TbsLog.i("TbsApkDownloader", "[TbsApkDownloader.copyTbsApkFromBackupToInstall] verifyTbsApk error!!");
               return false;
            } else {
               return true;
            }
         ...
         TbsLog.e("TbsApkDownloader", "[TbsApkDownloader.copyTbsApkFromBackupToInstall] Exception is " + var5.getMessage());
         return false;
      }
   }
   ...
   public boolean a(boolean var1, boolean var2) {
      ...
      if (VERSION.SDK_INT == 23) {
         ...
         int var5 = com.tencent.smtt.sdk.o.a().j(this.context);
         if (var4 == 0) {
         ...
         if (var4 != 0 && var4 != var5) {
            if (var2) {
               ...
               if (var6 != null && var6.exists()) {
                  var7 = new File(FileUtil.a(this.context, 4), TbsDownloader.getOverSea(this.context) ? "x5.oversea.tbs.org" : TbsDownloader.getBackupFileName(false));

                  try {
                     if (TbsDownloadConfig.getInstance(this.context).mPreferences.getInt("tbs_download_version_type", 0) != 1) {
                        FileUtil.b(var6, var7);
                        var3 = true;
                     }
               ...
               if (var7 != null && var7.exists() && this.a(var7)) {
                  ...
                  this.j();
                  if (var6 != null && var6.exists() && !ApkUtil.getApkVersion(this.context, var6, 0L, var4) && var6 != null && var6.exists()) {
                     FileUtil.b(var6);
                  }
               }
            }

            if (this.c(false, var2)) {
               TbsDownloadConfig.getInstance(this.context).mSyncMap.put("tbs_download_interrupt_code_reason", -214);
               TbsDownloadConfig.getInstance(this.context).setDownloadInterruptCode(-214);
               this.d(false);
               return true;
               ...
               if (!var10) {
                  var10 = this.e(true);
                  if (!var10) {
                     TbsLog.e("TbsApkDownloader", "[TbsApkDownloader] delete file failed!");
   ...
   public boolean verifyAndInstallDecoupleCoreFromBackup() {
      ...
      try {
         File var1 = new File(FileUtil.a(this.context, 4), TbsDownloader.getBackupFileName(true));
         if (var1 != null && var1.exists()) {
            ...
            if (var2 != null && var2.exists()) {
               FileUtil.b(var2, var1);
            }
         }

         if (ApkUtil.getApkVersion(this.context, var1, 0L, TbsDownloadConfig.getInstance(this.context).mPreferences.getInt("tbs_decouplecoreversion", -1))) {
            TbsLog.i("TbsApkDownloader", "verifyAndInstallDecoupleCoreFromBackup #3");
            return com.tencent.smtt.sdk.o.a().f(this.context);
         }
   ...
   public void b(boolean var1, boolean var2) {
      boolean var3 = com.tencent.smtt.sdk.o.a().isTbsLocalInstalled(this.context);
      if (var3 && !var1) {
         TbsDownloader.a = false;
         ...
         if (!var2 && this.a(var1, var5)) {
            ...
            this.D = var1;
            this.tbs_downloadurl = TbsDownloadConfig.getInstance(this.context).mPreferences.getString("tbs_downloadurl", (String)null);
            String var6 = TbsDownloadConfig.getInstance(this.context).mPreferences.getString("tbs_downloadurl_list", (String)null);
            TbsLog.i("TbsApkDownloader", "backupUrlStrings:" + var6, true);
            this.b = null;
            this.c = 0;
            ...
            TbsLog.i("TbsApkDownloader", "[TbsApkDownloader.startDownload] mDownloadUrl=" + this.tbs_downloadurl + " backupUrlStrings=" + var6 + " mLocation=" + this.k + " mCanceled=" + this.s + " mHttpRequest=" + this.u);
            if (this.tbs_downloadurl == null && this.k == null) {
            ...
            } else if (!var1 && this.B.contains(Apn.getWifiSSID(this.context))) {
               TbsLog.i("TbsApkDownloader", "[TbsApkDownloader.startDownload] WIFI Unavailable");
               QbSdk.m.onDownloadFinish(110);
               TbsDownloadConfig.getInstance(this.context).setDownloadInterruptCode(-304);
            } else {
               this.g();
               TbsLog.i("TbsApkDownloader", "STEP 1/2 begin downloading...", true);
                  ...
                  try {
                     if (!var1) {
                        ...
                        if (var12 - var16 > 86400000L) {
                           TbsLog.i("TbsApkDownloader", "[TbsApkDownloader.startDownload] OVER DOWNLOAD_PERIOD");
                           ...
                           TbsLog.i("TbsApkDownloader", "[TbsApkDownloader.startDownload] downloadFlow=" + var10);
                           if (var10 >= var7) {
                              TbsLog.i("TbsApkDownloader", "STEP 1/2 begin downloading...failed because you exceeded max flow!", true);
                        ...
                        if (!FileUtil.b(this.context)) {
                           TbsLog.i("TbsApkDownloader", "DownloadBegin FreeSpace too small", true);
                     ...
                     this.z = true;
                     String var14 = this.k != null ? this.k : this.tbs_downloadurl;
                     TbsLog.i("TbsApkDownloader", "try url:" + var14 + ",mRetryTimes:" + this.q, true);
                     if (!var14.equals(this.j)) {
                        this.w.setDownloadUrl(var14);
                     }

                     this.j = var14;
                     this.initHttpRequest(var14);
                     long var15 = 0L;
                     if (!this.p) {
                        var15 = this.x5tbstempLength();
                        TbsLog.i("TbsApkDownloader", "[TbsApkDownloader.startDownload] range=" + var15);
                        if (this.m <= 0L) {
                           TbsLog.i("TbsApkDownloader", "STEP 1/2 begin downloading...current" + var15, true);
                           this.u.setRequestProperty("Range", "bytes=" + var15 + "-");
                        } else {
                           TbsLog.i("TbsApkDownloader", "#1 STEP 1/2 begin downloading...current/total=" + var15 + "/" + this.m, true);
                     ...
                     if (this.q >= 1) {
                        this.u.addRequestProperty("Referer", this.tbs_downloadurl);
                     }

                     int var19 = this.u.getResponseCode();
                     TbsLog.i("TbsApkDownloader", "[TbsApkDownloader.startDownload] responseCode=" + var19);
                     ...
                     if (!var1 && !TbsDownloader.getOverSea(this.context) && (Apn.getApnType(this.context) != 3 || Apn.getApnType(this.context) == 0) && !QbSdk.getDownloadWithoutWifi()) {
                        ...
                        TbsLog.i("TbsApkDownloader", "Download is canceled due to NOT_WIFI error!", false);
                     }
                     ...
                     if (var19 != 200 && var19 != 206) {
                        if (var19 >= 300 && var19 <= 307) {
                           ...
                           if (var19 != 202) {
                              if (this.q < this.C && var19 == 503) {
                                 ...
                                 if (this.x5tbstempLength() > 0L || this.p || var19 == 410) {
                        ...
                        TbsLog.i("TbsApkDownloader", "[TbsApkDownloader.startDownload] mContentLength=" + this.m);
                        ...
                        if (var20 != 0L && this.m != var20) {
                           TbsLog.i("TbsApkDownloader", "DownloadBegin tbsApkFileSize=" + var20 + "  but contentLength=" + this.m, true);
                           ...
                           Object var24 = null;
                           TbsLog.i("TbsApkDownloader", "[TbsApkDownloader.startDownload] begin readResponse");
                           ...
                           try {
                              ...
                              if (var23 != null) {
                                 ...
                                 label1479: {
                                    while(!this.s) {
                                       ...
                                       if (var54 <= 0) {
                                          if (this.b != null && !this.c(true, var5)) {
                                       ...
                                       if (!var1) {
                                          ...
                                          if (!FileUtil.b(this.context)) {
                                             TbsLog.i("TbsApkDownloader", "DownloadEnd FreeSpace too small ", true);
                                             this.a(105, (String)("freespace=" + com.tencent.smtt.utils.p.a() + ",and minFreeSpace=" + TbsDownloadConfig.getInstance(this.context).getDownloadMinFreeSpace()), true);
                                             TbsDownloadConfig.getInstance(this.context).setDownloadInterruptCode(-308);
                                             break label1479;
                                          }
                                       }
                                       ...
                                       if (var35 - var32 > 1000L) {
                                          TbsLog.i("TbsApkDownloader", "#2 STEP 1/2 begin downloading...current/total=" + var29 + "/" + this.m, true);
                                          if (QbSdk.m != null) {
                                          ...
                                          if (!var1 && var29 - var27 > 1048576L) {
                                             ...
                                             if (!TbsDownloader.getOverSea(this.context) && (Apn.getApnType(this.context) != 3 || Apn.getApnType(this.context) == 0) && !QbSdk.getDownloadWithoutWifi()) {
                                                ...
                                                TbsLog.i("TbsApkDownloader", "Download is paused due to NOT_WIFI error!", false);
                                                TbsDownloadConfig.getInstance(this.context).setDownloadInterruptCode(-304);
                                                break label1479;
                                             }
                                          }
                                    ...
                                    TbsLog.i("TbsApkDownloader", "STEP 1/2 begin downloading...Canceled!", true);
                                    TbsDownloadConfig.getInstance(this.context).setDownloadInterruptCode(-309);
                                 }
                              ...
                              if (!(var48 instanceof SocketTimeoutException) && !(var48 instanceof SocketException)) {
                                 if (!var1 && !FileUtil.b(this.context)) {
                                    this.a(105, (String)("freespace=" + com.tencent.smtt.utils.p.a() + ",and minFreeSpace=" + TbsDownloadConfig.getInstance(this.context).getDownloadMinFreeSpace()), true);
                                    TbsDownloadConfig.getInstance(this.context).setDownloadInterruptCode(-308);
                                    break;
                                 }
                     ...
                     if (var50 instanceof SSLHandshakeException && !var1 && this.b != null && this.b(false)) {
                        TbsLog.e("TbsApkDownloader", "[startdownload]url:" + this.k + " download exception：" + var50.toString());
   ...
   private void d(boolean var1) {
      com.tencent.smtt.utils.p.a(this.context);
      TbsDownloadConfig var2 = TbsDownloadConfig.getInstance(this.context);
      var2.mSyncMap.put("request_full_package", false);
      var2.mSyncMap.put("tbs_needdownload", false);
      var2.mSyncMap.put("tbs_download_interrupt_code_reason", -123);
      var2.commit();
      QbSdk.m.onDownloadFinish(var1 ? 100 : 120);
      int var3 = var2.mPreferences.getInt("tbs_responsecode", 0);
      ...
      if (var3 == 5) {
         ...
         com.tencent.smtt.sdk.o.a().b(this.context, var5);
      } else if (var3 != 3 && var3 <= 10000) {
         int var8 = var2.mPreferences.getInt("tbs_download_version", 0);
         com.tencent.smtt.sdk.o.a().installTbsCore(this.context, (new File(this.l, "x5.tbs")).getAbsolutePath(), var8);
         backupTbsApk(new File(this.l, "x5.tbs"), this.context);
      } else {
         File var7 = backupApkPath(this.context);
         if (var7 != null) {
            Bundle var6 = this.a(var3, var7, var4);
            com.tencent.smtt.sdk.o.a().b(this.context, var6);
         } else {
            this.c();
            var2.mSyncMap.put("tbs_needdownload", true);
            var2.commit();
         }
      }
   ...
   public Bundle a(int var1, boolean var2) {
      ...
      int var4;
      if (var2) {
         var3 = com.tencent.smtt.sdk.o.a().q(this.context);
         var4 = com.tencent.smtt.sdk.o.a().i(this.context);
      } else {
         var3 = com.tencent.smtt.sdk.o.a().r(this.context);
         var4 = com.tencent.smtt.sdk.o.a().j(this.context);
      }
      ...
      if (var6 == null) {
         ...
         File var8;
         if (var2) {
            var8 = com.tencent.smtt.sdk.o.a().f(this.context, 6);
         } else {
            var8 = com.tencent.smtt.sdk.o.a().f(this.context, 5);
         }
         ...
         String var10 = FileUtil.a(this.context, 7);
   ...
   public Bundle a(int var1, File var2, boolean var3) {
      ...
      int var5 = ApkUtil.getApkVersion(this.context, var4);
   ...
   private File i() {
      File var1 = new File(FileUtil.a(this.context, 4), TbsDownloader.getOverSea(this.context) ? "x5.oversea.tbs.org" : TbsDownloader.getBackupFileName(false));
      if (TbsDownloader.a(this.context)) {
         var1 = new File(FileUtil.a(this.context, 4), TbsDownloader.getBackupFileName(true));
      }
   ...
   private boolean a(File var1) {
      ...
      return ApkUtil.getApkVersion(this.context, var1, 0L, var2);
   }

   private boolean c(boolean var1, boolean var2) {
      TbsLog.i("TbsApkDownloader", "[TbsApkDownloader.verifyTbsApk] isTempFile=" + var1);
      File var3 = new File(this.l, !var1 ? "x5.tbs" : "x5.tbs.temp");
      if (!var3.exists()) {
         return false;
      } else {
         String var4 = TbsDownloadConfig.getInstance(this.context).mPreferences.getString("tbs_apk_md5", (String)null);
         String var5 = ApkUtil.a(var3);
         if (var4 != null && var4.equals(var5)) {
            TbsLog.i("TbsApkDownloader", "[TbsApkDownloader.verifyTbsApk] md5(" + var5 + ") successful!");
            long var6 = 0L;
            if (var1) {
               long var8 = TbsDownloadConfig.getInstance(this.context).mPreferences.getLong("tbs_apkfilesize", 0L);
               if (var3 == null || !var3.exists() || var8 > 0L && var8 != (var6 = var3.length())) {
                  TbsLog.i("TbsApkDownloader", "[TbsApkDownloader.verifyTbsApk] isTempFile=" + var1 + " filelength failed");
                  this.w.setCheckErrorDetail("fileLength:" + var6 + ",contentLength:" + var8);
                  return false;
               }
            }

            TbsLog.i("TbsApkDownloader", "[TbsApkDownloader.verifyTbsApk] length(" + var6 + ") successful!");
            int var13 = -1;
            if (var2 && !var1) {
               var13 = ApkUtil.getApkVersion(this.context, var3);
               int var9 = TbsDownloadConfig.getInstance(this.context).mPreferences.getInt("tbs_download_version", 0);
               if (var9 != var13) {
                  TbsLog.i("TbsApkDownloader", "[TbsApkDownloader.verifyTbsApk] isTempFile=" + var1 + " versionCode failed");
                  if (var1) {
            ...
            TbsLog.i("TbsApkDownloader", "[TbsApkDownloader.verifyTbsApk] tbsApkVersionCode(" + var13 + ") successful!");
            if (var2 && !var1) {
               String var14 = com.tencent.smtt.utils.AppUtil.getSignatureFromApk(this.context, false, var3);
               if (!"".equals(var14)) {
                  TbsLog.i("TbsApkDownloader", "[TbsApkDownloader.verifyTbsApk] isTempFile=" + var1 + " signature failed");
                  if (var1) {
            ...
            TbsLog.i("TbsApkDownloader", "[TbsApkDownloader.verifyTbsApk] signature successful!");
            boolean var15 = false;
            if (var1) {
               Exception var10 = null;

               try {
                  var15 = var3.renameTo(new File(this.l, "x5.tbs"));
            ...
            TbsLog.i("TbsApkDownloader", "[TbsApkDownloader.verifyTbsApk] rename(" + var15 + ") successful!");
            return true;
         } else {
            TbsLog.i("TbsApkDownloader", "[TbsApkDownloader.verifyTbsApk] isTempFile=" + var1 + " md5 failed");
            if (var1) {
   ...
   private boolean e(boolean var1) {
      TbsLog.i("TbsApkDownloader", "[TbsApkDownloader.deleteFile] isApk=" + var1);
      File var2 = null;
      if (var1) {
   ...
   private void j() {
      try {
         ...
         if (var1 != null && var1.exists()) {
            ...
            String var3 = ApkUtil.a(TbsDownloader.a(this.context)) + "(.*)";
   ...
   private boolean x5tbstempExists() {
      boolean var1 = false;
   ...
   private String getHostAddress(URL var1) {
      String var2 = "";
   ...
   @TargetApi(8)
   static File backupApkPath(Context var0) {
      File var1 = null;

      try {
         if (VERSION.SDK_INT >= 8) {
            var1 = new File(FileUtil.a(var0, 4));
         }
         ...
         TbsLog.e("TbsApkDownloader", "[TbsApkDownloader.backupApkPath] Exception is " + var3.getMessage());
         return null;
      }
   }
   ...
   private static File a(Context var0, int var1) {
      File var2 = new File(FileUtil.a(var0, var1));
   ...
   public int c(boolean var1) {
      File var2 = backupApkPath(this.context);
      if (var1) {
         return var2 == null ? 0 : ApkUtil.getApkVersion(this.context, new File(var2, TbsDownloader.getBackupFileName(true)));
      } else {
         return var2 == null ? 0 : ApkUtil.getApkVersion(this.context, new File(var2, TbsDownloader.getOverSea(this.context) ? "x5.oversea.tbs.org" : TbsDownloader.getBackupFileName(false)));
      }
   }
   ...
   public void a(int var1) {
      if (com.tencent.smtt.sdk.o.a().u(this.context)) {
         com.tencent.smtt.sdk.o.a().b();

         try {
            File var2 = new File(this.l, "x5.tbs");
            int var3 = ApkUtil.getApkVersion(this.context, var2);
               ...
               try {
                  ...
                  if (var3 != null) {
                     ...
                     if (var6 || var5) {
                        ...
                        File var20 = new File(var3, ApkUtil.a(var6) + "." + var11);
                        if (var20 != null && var20.exists()) {
                           TbsLog.e("TbsApkDownloader", "[TbsApkDownloader.backupTbsApk]delete bacup config file error ");
                           return;
                        }
                     ...
                     if (TbsDownloadConfig.getInstance(var1).mPreferences.getInt("tbs_download_version_type", 0) != 1 && TbsDownloadConfig.getInstance(var1).mPreferences.getInt("tbs_decouplecoreversion", 0) == ApkUtil.getApkVersion(var1, var0)) {
                        ...
                        var4 = new File(var3, TbsDownloader.getBackupFileName(true));
                        if (ApkUtil.getApkVersion(var1, var0) != ApkUtil.getApkVersion(var1, var4)) {
                           var4.delete();
                           FileUtil.b(var0, var4);
                           return;
                        }
   ...
   public static void c(Context var0) {
      try {
         com.tencent.smtt.sdk.o.a();
         File var1 = com.tencent.smtt.sdk.o.t(var0);
         (new File(var1, "x5.tbs")).delete();
         (new File(var1, "x5.tbs.temp")).delete();
         File var2 = backupApkPath(var0);
         if (var2 != null) {
   ...
   private boolean detectWifiNetworkAvailable() {
      ...
      boolean var2 = false;
      String var3 = null;
      TbsLog.i("TbsApkDownloader", "[TbsApkDwonloader.detectWifiNetworkAvailable] isWifi=" + var1);
      if (var1) {
         var3 = Apn.getWifiSSID(this.context);
         TbsLog.i("TbsApkDownloader", "[TbsApkDwonloader.detectWifiNetworkAvailable] localBSSID=" + var3);
         HttpURLConnection var4 = null;

         try {
            URL var5 = new URL("https://pms.mb.qq.com/rsp204");
            ...
            TbsLog.i("TbsApkDownloader", "[TbsApkDwonloader.detectWifiNetworkAvailable] responseCode=" + var6);
            var2 = var6 == 204;
      ...
      if (!var2 && !TextUtils.isEmpty(var3) && !this.B.contains(var3)) {
         this.B.add(var3);
         this.p();
         Message var17 = this.A.obtainMessage(150, var3);
         this.A.sendMessageDelayed(var17, 120000L);
      }

      if (var2 && this.B.contains(var3)) {
         this.B.remove(var3);
      }
   ...
   private void p() {
      if (this.A == null) {
         this.A = new Handler(com.tencent.smtt.sdk.n.a().getLooper()) {
            public void handleMessage(Message var1) {
               if (var1.what == 150) {
                  l.this.detectWifiNetworkAvailable();
               }
   ...
   public boolean isDownloadForeground() {
      TbsLog.i("TbsApkDownloader", "[TbsApkDownloader.isDownloadForeground] mIsDownloadForeground=" + this.D);
      return this.D;
   }

   void pauseDownload() {
      TbsLog.i("TbsApkDownloader", "pauseDownload,isPause=" + this.d + "isDownloading=" + TbsDownloader.isDownloading());
   ...
   void resumeDownload() {
      TbsLog.i("TbsApkDownloader", "resumeDownload,isPause=" + this.d + "isDownloading=" + TbsDownloader.isDownloading());
      if (this.d && TbsDownloader.isDownloading()) {
         this.d = false;
         this.a(false);
      }
