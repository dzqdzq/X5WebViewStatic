...
class TbsWizard {
   ...
   public TbsWizard(Context var1, Context var2, String var3, String var4, String[] var5, String var6) throws Exception {
      ...
      if (var1 != null && (var2 != null || TbsShareManager.getHostCorePathAppDefined() != null) && !TextUtils.isEmpty(var3) && var5 != null && var5.length != 0) {
         ...
         this.e = new DexLoader(var6, this.a, this.d, var4, QbSdk.n);
   ...
   void a(Context var1) {
      ...
      if (var2) {
         TbsCheckUtils.b(var1);
      }

   }

   public void continueInit(Context var1, Context var2, String var3, String var4, String[] var5, String var6) throws Exception {
      this.a = var1.getApplicationContext();
   ...
   private int initTesRuntimeEnvironment(Context var1) {
      ...
      if (this.b == null && TbsShareManager.getHostCorePathAppDefined() != null) {
         var3 = this.e.invokeStaticMethod("com.tencent.tbs.tbsshell.TBSShell", "initTesRuntimeEnvironment", new Class[]{Context.class, Context.class, DexLoader.class, String.class, String.class, String.class, Integer.TYPE, String.class, String.class}, var1, this.b, this.e, this.c, this.f, "4.3.0.151", 44051, QbSdk.a(), TbsShareManager.getHostCorePathAppDefined());
      } else {
         TbsLog.i("TbsWizard", "initTesRuntimeEnvironment callerContext is " + var1 + " mHostContext is " + this.b + " mDexLoader is " + this.e + " mtbsInstallLocation is " + this.c + " mDexOptPath is " + this.f);
         var3 = this.e.invokeStaticMethod("com.tencent.tbs.tbsshell.TBSShell", "initTesRuntimeEnvironment", new Class[]{Context.class, Context.class, DexLoader.class, String.class, String.class, String.class, Integer.TYPE, String.class}, var1, this.b, this.e, this.c, this.f, "4.3.0.151", 44051, QbSdk.a());
      }

      if (var3 == null) {
         this.c();
         this.d();
         var3 = this.e.invokeStaticMethod("com.tencent.tbs.tbsshell.TBSShell", "initTesRuntimeEnvironment", new Class[]{Context.class, Context.class, DexLoader.class, String.class, String.class}, var1, this.b, this.e, this.c, this.f);
      }
      ...
      if (var6 < 0) {
         Object var4 = this.e.invokeStaticMethod("com.tencent.tbs.tbsshell.TBSShell", "getLoadFailureDetails", new Class[0]);
   ...
   private void c() {
      this.e.invokeStaticMethod("com.tencent.tbs.tbsshell.TBSShell", "setTesSdkVersionName", new Class[]{String.class}, "4.3.0.151");
   }

   private void d() {
      this.e.setStaticField("com.tencent.tbs.tbsshell.TBSShell", "VERSION", 44051);
   }

   public String a() {
      String var1 = null;
      Object var2 = this.e.invokeStaticMethod("com.tencent.tbs.tbsshell.WebCoreProxy", "invokeStaticMethod", new Class[]{Boolean.TYPE, String.class, String.class, Class[].class, Object[].class}, true, "com.tencent.smtt.util.CrashTracker", "getCrashExtraInfo", null, new Object[0]);
      if (var2 == null) {
         var2 = this.e.invokeStaticMethod("com.tencent.smtt.util.CrashTracker", "getCrashExtraInfo", (Class[])null);
      }
   ...
   public boolean a(Context var1, String var2, String var3, Bundle var4) {
      Object var5 = this.e.invokeStaticMethod("com.tencent.tbs.tbsshell.WebCoreProxy", "installLocalQbApk", new Class[]{Context.class, String.class, String.class, Bundle.class}, var1, var2, var3, var4);
