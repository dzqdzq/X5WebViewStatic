...
public class WebViewClient {
   ...
   public boolean shouldOverrideUrlLoading(WebView var1, WebResourceRequest var2) {
      return this.mX5Client != null ? this.mX5Client.shouldOverrideUrlLoading(var1.b(), var2.getUrl().toString()) : this.shouldOverrideUrlLoading(var1, var2.getUrl().toString());
   }

   public void onPageStarted(WebView var1, String var2, Bitmap var3) {
      if (this.mX5Client != null) {
         this.mX5Client.a(var1, var2, var3);
      }
   ...
   public void onReceivedError(WebView var1, WebResourceRequest var2, WebResourceError var3) {
      if (this.mX5Client != null) {
         if (var2.isForMainFrame()) {
            this.mX5Client.onReceivedError(var1.b(), var3.getErrorCode(), var3.getDescription().toString(), var2.getUrl().toString());
         }
   ...
   public WebResourceResponse shouldInterceptRequest(WebView var1, WebResourceRequest var2) {
      return this.mX5Client != null ? this.mX5Client.shouldInterceptRequest(var1.b(), var2.getUrl().toString()) : this.shouldInterceptRequest(var1, var2.getUrl().toString());
   }

   public WebResourceResponse shouldInterceptRequest(WebView var1, WebResourceRequest var2, Bundle var3) {
      return this.mX5Client != null ? this.mX5Client.shouldInterceptRequest(var1.b(), var2) : null;
   }
   ...
   public boolean onRenderProcessGone(WebView var1, WebViewClient.RenderProcessGoneDetail var2) {
      return false;
   }
