...
public class e {
   ...
   public static String d(String var0) {
      String var1 = "*/*";
      String var2 = var0.substring(var0.lastIndexOf(".") + 1, var0.length());
      String var3 = "";
      if (TextUtils.isEmpty(var2)) {
         ...
         for(int var4 = 0; var4 < a.length; ++var4) {
            if (var3.equalsIgnoreCase(a[var4][0])) {
               var1 = a[var4][1];
               break;
            }
         }
         ...
         if ("*/*".equalsIgnoreCase(var1)) {
            var1 = MimeTypeMap.getSingleton().getMimeTypeFromExtension(var2.toLowerCase());
         }

         if (var1 == null) {
            HashMap var5 = new HashMap();
            var5.put("3gp", "video/3gpp");
            var5.put("chm", "text/plain");
            var5.put("ape", "audio/x-ape");
            var1 = (String)var5.get(var2.toLowerCase());
         }
