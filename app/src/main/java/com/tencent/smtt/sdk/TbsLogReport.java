...
public class TbsLogReport {
   ...
   private void a(int var1, TbsLogReport.TbsLogInfo var2) {
      if (QbSdk.n != null && QbSdk.n.containsKey("SET_SENDREQUEST_AND_UPLOAD") && QbSdk.n.get("SET_SENDREQUEST_AND_UPLOAD").equals("false")) {
         ...
         if (com.tencent.smtt.utils.AppUtil.getImeiEnable(this.c)) {
            var3.append(this.a(com.tencent.smtt.utils.AppUtil.getImei(this.c)));
         }

         var3.append(this.a(com.tencent.smtt.utils.j.a(this.c)));
         var3.append(this.a(o.a().j(this.c)));
         ...
         if ("com.tencent.mm".equals(var6)) {
            var3.append(this.a(com.tencent.smtt.utils.AppUtil.a(this.c, "com.tencent.mm.BuildInfo.CLIENT_VERSION")));
         } else {
            var3.append(this.a(com.tencent.smtt.utils.AppUtil.d(this.c)));
         }
         ...
         var3.append(this.a(com.tencent.smtt.utils.AppUtil.getAndroidID(this.c)));
         String var7 = "4.3.0.151_44051";
   ...
   public void reportTbsLog() {
      if (QbSdk.n != null && QbSdk.n.containsKey("SET_SENDREQUEST_AND_UPLOAD") && QbSdk.n.get("SET_SENDREQUEST_AND_UPLOAD").equals("false")) {
         ...
         if (var1 != null) {
            String var2 = com.tencent.smtt.utils.g.a().b();
            String var3 = "";
            if (com.tencent.smtt.utils.AppUtil.getImeiEnable(this.c)) {
               var3 = com.tencent.smtt.utils.AppUtil.getImei(this.c);
            }

            String var4 = com.tencent.smtt.utils.AppUtil.getAndroidID(this.c);
            byte[] var5 = var3.getBytes();
            byte[] var6 = var4.getBytes();

            try {
               var5 = com.tencent.smtt.utils.g.a().a(var5);
               var6 = com.tencent.smtt.utils.g.a().a(var6);
            } catch (Exception var30) {
            }

            var3 = com.tencent.smtt.utils.g.b(var5);
            var4 = com.tencent.smtt.utils.g.b(var6);
            String var7 = com.tencent.smtt.utils.m.a(this.c).e() + var3 + "&aid=" + var4;
            HashMap var8 = new HashMap();
            var8.put("Content-Type", "application/octet-stream");
            var8.put("Charset", "UTF-8");
            var8.put("QUA2", com.tencent.smtt.utils.j.a(this.c));
            ...
            try {
               new File(FileUtil.a);
               TbsLogReport.a var14 = new TbsLogReport.a(var1, FileUtil.a + "/tbslog_temp.zip");
               var14.a();
               var10 = new File(FileUtil.a, "tbslog_temp.zip");
               ...
               var11.flush();
               var12 = com.tencent.smtt.utils.g.a().a(var11.toByteArray());
   ...
   private void b() {
      if (QbSdk.n != null && QbSdk.n.containsKey("SET_SENDREQUEST_AND_UPLOAD") && QbSdk.n.get("SET_SENDREQUEST_AND_UPLOAD").equals("false")) {
         ...
         if (var1 != null && var1.length() != 0) {
            ...
            try {
               com.tencent.smtt.utils.m var2 = com.tencent.smtt.utils.m.a(this.c);
               String var3 = var2.c();
